...
/**
 * BranchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BranchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BranchRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['branch_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'branch_id', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setBranchId($branch_id)
    {
        ...
        if ((mb_strlen($branch_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $branch_id when calling BranchRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling BranchRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((mb_strlen($color) < 1)) {
            throw new \InvalidArgumentException('invalid length for $color when calling BranchRequest., must be bigger than or equal to 1.');
        }
