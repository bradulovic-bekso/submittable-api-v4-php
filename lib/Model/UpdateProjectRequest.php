...
class UpdateProjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'success_url' => 'string',
        'review_stages' => '\OpenAPI\Client\Model\ReviewStageRequest[]',
        ...
        'gallery' => '\OpenAPI\Client\Model\ProjectGalleryRequest',
        ...
        'request_form_criteria' => '\OpenAPI\Client\Model\RequestFormCriteriaRequest[]',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateProjectRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
     ...
     * Gets review_stages
     *
     * @return \OpenAPI\Client\Model\ReviewStageRequest[]|null
     */
     ...
     * Sets review_stages
     *
     * @param \OpenAPI\Client\Model\ReviewStageRequest[]|null $review_stages review_stages
     *
     * @return self
     */
     ...
     * Gets gallery
     *
     * @return \OpenAPI\Client\Model\ProjectGalleryRequest|null
     */
     ...
     * Sets gallery
     *
     * @param \OpenAPI\Client\Model\ProjectGalleryRequest|null $gallery gallery
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\RequestFormCriteriaRequest[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RequestFormCriteriaRequest[]|null $request_form_criteria request_form_criteria
     *
     * @return self
     */
