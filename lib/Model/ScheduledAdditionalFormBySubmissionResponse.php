<?php
/**
 * ScheduledAdditionalFormBySubmissionResponse
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ScheduledAdditionalFormBySubmissionResponse Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class ScheduledAdditionalFormBySubmissionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduledAdditionalFormBySubmissionResponse';
    ...
    protected static $openAPITypes = [
        ...
        'is_deleted' => 'bool',
        'deleted_at' => '\DateTime',
        'additional_form_request_id' => 'string',
        'deadline' => '\DateTime',
    ...
    protected static $openAPIFormats = [
        ...
        'additional_form_request_id' => null,
        'deadline' => 'date-time',
    ...
    protected static array $openAPINullables = [
        'id' => true,
        'scheduled_at' => true,
        'scheduled_task_id' => true,
        'additional_form_id' => true,
        'submission_id' => true,
        'project_id' => true,
        'is_deleted' => false,
        'deleted_at' => true,
        'additional_form_request_id' => true,
        'deadline' => true,
    ...
    protected static $attributeMap = [
        ...
        'additional_form_request_id' => 'additionalFormRequestId',
        'deadline' => 'deadline',
    ...
    protected static $setters = [
        ...
        'additional_form_request_id' => 'setAdditionalFormRequestId',
    ...
    protected static $getters = [
        ...
        'additional_form_request_id' => 'getAdditionalFormRequestId',
    ...
    */
    ...
    {
        if (is_null($scheduled_task_id)) {
            array_push($this->openAPINullablesSetToNull, 'scheduled_task_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('scheduled_task_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $additional_form_id additional_form_id
     *
     * @return self
     */
    public function setAdditionalFormId($additional_form_id)
    {
        if (is_null($additional_form_id)) {
            array_push($this->openAPINullablesSetToNull, 'additional_form_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('additional_form_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets additional_form_request_id
     *
     * @return string|null
     */
    public function getAdditionalFormRequestId()
    {
        return $this->container['additional_form_request_id'];
    }

    /**
     * Sets additional_form_request_id
     *
     * @param string|null $additional_form_request_id additional_form_request_id
     *
     * @return self
     */
    public function setAdditionalFormRequestId($additional_form_request_id)
    {
        if (is_null($additional_form_request_id)) {
            array_push($this->openAPINullablesSetToNull, 'additional_form_request_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('additional_form_request_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['additional_form_request_id'] = $additional_form_request_id;
