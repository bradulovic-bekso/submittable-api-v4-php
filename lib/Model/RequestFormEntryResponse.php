...
/**
 * RequestFormEntryResponse Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class RequestFormEntryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestFormEntryResponse';
    ...
    protected static array $openAPINullables = [
        'submission_id' => true,
        'project_id' => true,
        'request_form_entry_status' => true,
    ...
    */
     ...
     *
     * @param string|null $request_form_entry_status request_form_entry_status
     *
     * @return self
     */
    public function setRequestFormEntryStatus($request_form_entry_status)
    {
        if (is_null($request_form_entry_status)) {
            array_push($this->openAPINullablesSetToNull, 'request_form_entry_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('request_form_entry_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getRequestFormEntryStatusAllowableValues();
        if (!is_null($request_form_entry_status) && !in_array($request_form_entry_status, $allowedValues, true)) {
