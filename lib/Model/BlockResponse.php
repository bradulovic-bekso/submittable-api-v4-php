 ...
 */
class BlockResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets block_type
     *
     * @param string|null $block_type block_type
     *
     * @return self
     */
    public function setBlockType($block_type)
    {
        if (is_null($block_type)) {
            array_push($this->openAPINullablesSetToNull, 'block_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('block_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
