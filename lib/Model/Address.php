    ...
    */
    ...
    public function setAddressTypeId($address_type_id)
    {
        if (is_null($address_type_id)) {
            array_push($this->openAPINullablesSetToNull, 'address_type_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_type_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setStateName($state_name)
    {
        if (is_null($state_name)) {
            array_push($this->openAPINullablesSetToNull, 'state_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('state_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
