...
/**
 * UpdateSubmissionsStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSubmissionsStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSubmissionsStatusRequest';
    ...
    protected static $openAPITypes = [
        ...
        'message' => '\OpenAPI\Client\Model\UpdateStatusCreateSubmissionMessageRequest',
        'template_id' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['submission_status'] === null) {
            $invalidProperties[] = "'submission_status' can't be null";
        }
     ...
     *
     * @param string $submission_status submission_status
     *
     * @return self
     */
    public function setSubmissionStatus($submission_status)
    {
        if (is_null($submission_status)) {
            throw new \InvalidArgumentException('non-nullable submission_status cannot be null');
        }
        $allowedValues = $this->getSubmissionStatusAllowableValues();
        if (!in_array($submission_status, $allowedValues, true)) {
     ...
     * Gets message
     *
     * @return \OpenAPI\Client\Model\UpdateStatusCreateSubmissionMessageRequest|null
     */
     ...
     * Sets message
     *
     * @param \OpenAPI\Client\Model\UpdateStatusCreateSubmissionMessageRequest|null $message message
     *
     * @return self
     */
    ...
    public function setSubmissionIds($submission_ids)
    {
        ...
        if ((count($submission_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $submission_ids when calling UpdateSubmissionsStatusRequest., number of items must be less than or equal to 500.');
        }
        if ((count($submission_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $submission_ids when calling UpdateSubmissionsStatusRequest., number of items must be greater than or equal to 1.');
        }
