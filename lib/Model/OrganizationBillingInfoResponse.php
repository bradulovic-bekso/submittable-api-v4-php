...
/**
 * OrganizationBillingInfoResponse Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class OrganizationBillingInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationBillingInfoResponse';
    ...
    protected static $openAPITypes = [
        'credit_card_info' => '\Submittable\Model\CreditCardInfo',
        'billing_address' => '\Submittable\Model\BillingAddress',
        'email' => 'string',
        'name' => 'string',
    ...
    protected static array $openAPINullables = [
        ...
        'email' => true,
        'name' => true,
        'stripe_subscription_customer_id' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'email' => 'email',
        'name' => 'name',
        'stripe_subscription_customer_id' => 'stripeSubscriptionCustomerId'
    ];
    ...
    protected static $setters = [
        ...
        'email' => 'setEmail',
        'name' => 'setName',
        'stripe_subscription_customer_id' => 'setStripeSubscriptionCustomerId'
    ];
    ...
    protected static $getters = [
        ...
        'email' => 'getEmail',
        'name' => 'getName',
        'stripe_subscription_customer_id' => 'getStripeSubscriptionCustomerId'
    ];
    ...
    {
        $this->setIfExists('credit_card_info', $data ?? [], null);
        $this->setIfExists('billing_address', $data ?? [], null);
        $this->setIfExists('email', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('stripe_subscription_customer_id', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Submittable\Model\CreditCardInfo|null
     */
     ...
     *
     * @param \Submittable\Model\CreditCardInfo|null $credit_card_info credit_card_info
     *
     * @return self
     */
    public function setCreditCardInfo($credit_card_info)
    {
        if (is_null($credit_card_info)) {
            throw new \InvalidArgumentException('non-nullable credit_card_info cannot be null');
        }
     ...
     *
     * @return \Submittable\Model\BillingAddress|null
     */
     ...
     *
     * @param \Submittable\Model\BillingAddress|null $billing_address billing_address
     *
     * @return self
     */
    ...
    /**
     * Gets stripe_subscription_customer_id
     *
     * @return string|null
     */
    public function getStripeSubscriptionCustomerId()
    {
        return $this->container['stripe_subscription_customer_id'];
    }

    /**
     * Sets stripe_subscription_customer_id
     *
     * @param string|null $stripe_subscription_customer_id stripe_subscription_customer_id
     *
     * @return self
     */
    public function setStripeSubscriptionCustomerId($stripe_subscription_customer_id)
    {
        if (is_null($stripe_subscription_customer_id)) {
            array_push($this->openAPINullablesSetToNull, 'stripe_subscription_customer_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('stripe_subscription_customer_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['stripe_subscription_customer_id'] = $stripe_subscription_customer_id;
