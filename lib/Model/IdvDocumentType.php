...
/**
 * IdvDocumentType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class IdvDocumentType
{
    ...
    public const I_D_CARD = 'iD_CARD';

    public const DRIVER_S_LICENSE = 'driverS_LICENSE';

    public const RESIDENC_E_PERMIT = 'residencE_PERMIT';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::PASSPORT,
            self::I_D_CARD,
            self::DRIVER_S_LICENSE,
            self::RESIDENC_E_PERMIT,
            self::VISA
        ];
    }
}
