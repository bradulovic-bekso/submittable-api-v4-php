...
/**
 * UpdateSubmissionPublicOrganizationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSubmissionPublicOrganizationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSubmissionPublicOrganizationRequest';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\SubmissionPublicOrganizationUpdateItem[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\SubmissionPublicOrganizationUpdateItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\SubmissionPublicOrganizationUpdateItem[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 500)) {
            throw new \InvalidArgumentException('invalid value for $items when calling UpdateSubmissionPublicOrganizationRequest., number of items must be less than or equal to 500.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling UpdateSubmissionPublicOrganizationRequest., number of items must be greater than or equal to 1.');
        }
