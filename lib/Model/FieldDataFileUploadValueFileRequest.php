...
class FieldDataFileUploadValueFileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'file_id' => 'string',
        'metadata' => '\Submittable\Model\FieldDataFileUploadValueFileMetadata[]',
        'file_name' => 'string',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Gets metadata
     *
     * @return \Submittable\Model\FieldDataFileUploadValueFileMetadata[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Submittable\Model\FieldDataFileUploadValueFileMetadata[]|null $metadata metadata
     *
     * @return self
     */
