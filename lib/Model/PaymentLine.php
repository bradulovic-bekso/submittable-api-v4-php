 ...
 */
class PaymentLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'is_grouping' => 'bool',
        'grouping' => '\OpenAPI\Client\Model\PaymentInfoGrouping',
        'item' => '\OpenAPI\Client\Model\PaymentInfo'
    ];
    ...
    {
        $this->setIfExists('is_grouping', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['is_grouping'];
    }

    /**
     * Sets is_grouping
     *
     * @param bool|null $is_grouping is_grouping
     *
     * @return self
     */
    public function setIsGrouping($is_grouping)
    {
        if (is_null($is_grouping)) {
            throw new \InvalidArgumentException('non-nullable is_grouping cannot be null');
        }
        $this->container['is_grouping'] = $is_grouping;
     ...
     * Gets grouping
     *
     * @return \OpenAPI\Client\Model\PaymentInfoGrouping|null
     */
     ...
     * Sets grouping
     *
     * @param \OpenAPI\Client\Model\PaymentInfoGrouping|null $grouping grouping
     *
     * @return self
     */
     ...
     * Gets item
     *
     * @return \OpenAPI\Client\Model\PaymentInfo|null
     */
     ...
     * Sets item
     *
     * @param \OpenAPI\Client\Model\PaymentInfo|null $item item
     *
     * @return self
     */
