...
/**
 * CharityCheckFieldResponseResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CharityCheckFieldResponseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharityCheckFieldResponseResponse';
    ...
    */
    ...
    public function setFieldType($field_type)
    {
        ...
        if ((mb_strlen($field_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_type when calling CharityCheckFieldResponseResponse., must be bigger than or equal to 1.');
        }
