...
/**
 * SendMessageToEntriesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SendMessageToEntriesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendMessageToEntriesRequest';
    ...
    */
    ...
    public function setEntryIds($entry_ids)
    {
        ...
        if ((count($entry_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $entry_ids when calling SendMessageToEntriesRequest., number of items must be less than or equal to 500.');
        }
        if ((count($entry_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $entry_ids when calling SendMessageToEntriesRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets message
     *
     * @return \OpenAPI\Client\Model\CreateSubmissionMessageRequest
     */
     ...
     * Sets message
     *
     * @param \OpenAPI\Client\Model\CreateSubmissionMessageRequest $message message
     *
     * @return self
     */
