...
/**
 * FormEntrySortField Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class FormEntrySortField
{
    /**
     * Possible values of this enum
     */
    public const DATE_SENT = 'dateSent';

    public const STATUS = 'status';

    public const DEADLINE = 'deadline';

    public const DATE_SUBMITTED = 'dateSubmitted';

    public const REQUEST_FORM_ENTRY_STATUS = 'requestFormEntryStatus';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::DEADLINE,
            self::DATE_SUBMITTED,
            self::REQUEST_FORM_ENTRY_STATUS
        ];
    }
}
