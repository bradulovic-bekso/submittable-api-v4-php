...
class TransactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $award_transaction_id award_transaction_id
     *
     * @return self
     */
    public function setAwardTransactionId($award_transaction_id)
    {
        if (is_null($award_transaction_id)) {
            array_push($this->openAPINullablesSetToNull, 'award_transaction_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('award_transaction_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
