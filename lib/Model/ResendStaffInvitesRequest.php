...
/**
 * ResendStaffInvitesRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class ResendStaffInvitesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResendStaffInvitesRequest';
    ...
    protected static $attributeMap = [
        'team_invite_codes' => 'teamInviteCodes'
    ];
    ...
    protected static $setters = [
        'team_invite_codes' => 'setTeamInviteCodes'
    ];
    ...
    protected static $getters = [
        'team_invite_codes' => 'getTeamInviteCodes'
    ];
    ...
    {
        $this->setIfExists('team_invite_codes', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['team_invite_codes'] === null) {
            $invalidProperties[] = "'team_invite_codes' can't be null";
        }
        if ((count($this->container['team_invite_codes']) > 500)) {
            $invalidProperties[] = "invalid value for 'team_invite_codes', number of items must be less than or equal to 500.";
        }

        if ((count($this->container['team_invite_codes']) < 1)) {
            $invalidProperties[] = "invalid value for 'team_invite_codes', number of items must be greater than or equal to 1.";
        }
    ...
    /**
     * Gets team_invite_codes
     *
     * @return string[]
     */
    public function getTeamInviteCodes()
    {
        return $this->container['team_invite_codes'];
    }

    /**
     * Sets team_invite_codes
     *
     * @param string[] $team_invite_codes team_invite_codes
     *
     * @return self
     */
    public function setTeamInviteCodes($team_invite_codes)
    {
        if (is_null($team_invite_codes)) {
            throw new \InvalidArgumentException('non-nullable team_invite_codes cannot be null');
        }

        if ((count($team_invite_codes) > 500)) {
            throw new \InvalidArgumentException('invalid value for $team_invite_codes when calling ResendStaffInvitesRequest., number of items must be less than or equal to 500.');
        }
        if ((count($team_invite_codes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $team_invite_codes when calling ResendStaffInvitesRequest., number of items must be greater than or equal to 1.');
        }
        $this->container['team_invite_codes'] = $team_invite_codes;
