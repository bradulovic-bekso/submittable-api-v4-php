...
/**
 * SubmissionSortField Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SubmissionSortField
{
    ...
    public const REVIEW_STAGE_SCORE = 'reviewStageScore';

    public const SUBMITTER_NAME = 'submitterName';

    public const PUBLIC_ORG_NAME = 'publicOrgName';

    public const ORGANIZATION_NAME = 'organizationName';

    public const PROJECT_TITLE = 'projectTitle';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::SUBMISSION_ID,
            self::SUBMISSION_TITLE,
            self::DATE,
            self::REVIEW_STAGE_SCORE,
            self::SUBMITTER_NAME,
            self::PUBLIC_ORG_NAME,
