...
/**
 * RemoveStaffInviteRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RemoveStaffInviteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoveStaffInviteRequest';
    ...
    */
    ...
    public function setEmails($emails)
    {
        ...
        if ((count($emails) > 500)) {
            throw new \InvalidArgumentException('invalid value for $emails when calling RemoveStaffInviteRequest., number of items must be less than or equal to 500.');
        }
        if ((count($emails) < 1)) {
            throw new \InvalidArgumentException('invalid length for $emails when calling RemoveStaffInviteRequest., number of items must be greater than or equal to 1.');
        }
