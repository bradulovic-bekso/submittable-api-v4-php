...
/**
 * CreateSubmissionMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class CreateSubmissionMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSubmissionMessageRequest';
    ...
    */
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling CreateSubmissionMessageRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setBody($body)
    {
        ...
        if ((mb_strlen($body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $body when calling CreateSubmissionMessageRequest., must be bigger than or equal to 1.');
        }
