...
/**
 * SyncPlaceholdersRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SyncPlaceholdersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SyncPlaceholdersRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['placeholder_id'] === null) {
            $invalidProperties[] = "'placeholder_id' can't be null";
        }
     ...
     * Sets placeholder_id
     *
     * @param string $placeholder_id placeholder_id
     *
     * @return self
     */
