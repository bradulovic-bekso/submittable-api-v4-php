...
/**
 * CreateResponseFileRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateResponseFileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateResponseFileRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['file_size_bytes'] > 5000000000)) {
            $invalidProperties[] = "invalid value for 'file_size_bytes', must be smaller than or equal to 5000000000.";
        }

        if (($this->container['file_size_bytes'] < 1)) {
            $invalidProperties[] = "invalid value for 'file_size_bytes', must be bigger than or equal to 1.";
        }
    ...
    public function setFileName($file_name)
    {
        ...
        if ((mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling CreateResponseFileRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFileSizeBytes($file_size_bytes)
    {
        ...
        if (($file_size_bytes > 5000000000)) {
            throw new \InvalidArgumentException('invalid value for $file_size_bytes when calling CreateResponseFileRequest., must be smaller than or equal to 5000000000.');
        }
        if (($file_size_bytes < 1)) {
            throw new \InvalidArgumentException('invalid value for $file_size_bytes when calling CreateResponseFileRequest., must be bigger than or equal to 1.');
        }
