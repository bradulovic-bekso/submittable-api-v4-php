 ...
 */
class CreateLabelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateLabelRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateLabelRequest., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateLabelRequest., must be bigger than or equal to 1.');
        }
