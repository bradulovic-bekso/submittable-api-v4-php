 ...
 */
class MetadataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('metadata_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['metadata_id'];
    }

    /**
     * Sets metadata_id
     *
     * @param string|null $metadata_id metadata_id
     *
     * @return self
     */
    public function setMetadataId($metadata_id)
    {
        if (is_null($metadata_id)) {
            array_push($this->openAPINullablesSetToNull, 'metadata_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('metadata_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['metadata_id'] = $metadata_id;
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling MetadataRequest., must be bigger than or equal to 1.');
        }
