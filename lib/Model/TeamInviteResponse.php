...
class TeamInviteResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'team_invite_id' => 'setTeamInviteId',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'team_invite_id' => 'getTeamInviteId',
        'code' => 'getCode',
    ...
    {
        $this->setIfExists('team_invite_id', $data ?? [], null);
        $this->setIfExists('code', $data ?? [], null);
        $this->setIfExists('invite_date', $data ?? [], null);
    ...
    */
     ...
     * @return int|null
     */
    public function getTeamInviteId()
    {
        return $this->container['team_invite_id'];
    }

    /**
     * Sets team_invite_id
     *
     * @param int|null $team_invite_id team_invite_id
     *
     * @return self
     */
    public function setTeamInviteId($team_invite_id)
    {
        if (is_null($team_invite_id)) {
            throw new \InvalidArgumentException('non-nullable team_invite_id cannot be null');
        }
        $this->container['team_invite_id'] = $team_invite_id;
     ...
     * Sets invite_date
     *
     * @param \DateTime|null $invite_date invite_date
     *
     * @return self
     */
    public function setInviteDate($invite_date)
    {
        if (is_null($invite_date)) {
            throw new \InvalidArgumentException('non-nullable invite_date cannot be null');
        }
