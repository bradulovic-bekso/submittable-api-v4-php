...
/**
 * BulkImportSubmissionsRequestSubmissionsInner Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class BulkImportSubmissionsRequestSubmissionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkImportSubmissionsRequest_submissions_inner';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling BulkImportSubmissionsRequestSubmissionsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling BulkImportSubmissionsRequestSubmissionsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling BulkImportSubmissionsRequestSubmissionsInner., must be bigger than or equal to 1.');
        }
     ...
     * Gets field_data
     *
     * @return \Submittable\Model\AdditionalFormEntryResponseFieldDataInner[]
     */
     ...
     * Sets field_data
     *
     * @param \Submittable\Model\AdditionalFormEntryResponseFieldDataInner[] $field_data field_data
     *
     * @return self
     */
