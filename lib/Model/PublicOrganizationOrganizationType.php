<?php
/**
 * PublicOrganizationOrganizationType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PublicOrganizationOrganizationType Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class PublicOrganizationOrganizationType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicOrganizationOrganizationType';
    ...
    protected static $openAPIFormats = [
        'type' => null,
        'deductibility_limitation' => null,
        'deductibility_status_description' => null
    ];
    ...
    protected static array $openAPINullables = [
        'type' => true,
        'deductibility_limitation' => true,
        'deductibility_status_description' => true
    ];
    ...
    protected static $attributeMap = [
        'type' => 'type',
        'deductibility_limitation' => 'deductibilityLimitation',
        'deductibility_status_description' => 'deductibilityStatusDescription'
    ];
    ...
    protected static $setters = [
        'type' => 'setType',
        'deductibility_limitation' => 'setDeductibilityLimitation',
        'deductibility_status_description' => 'setDeductibilityStatusDescription'
    ];
    ...
    protected static $getters = [
        'type' => 'getType',
        'deductibility_limitation' => 'getDeductibilityLimitation',
        'deductibility_status_description' => 'getDeductibilityStatusDescription'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('deductibility_limitation', $data ?? [], null);
        $this->setIfExists('deductibility_status_description', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets deductibility_limitation
     *
     * @return string|null
     */
    public function getDeductibilityLimitation()
    {
        return $this->container['deductibility_limitation'];
    }

    /**
     * Sets deductibility_limitation
     *
     * @param string|null $deductibility_limitation deductibility_limitation
     *
     * @return self
     */
    public function setDeductibilityLimitation($deductibility_limitation)
    {
        if (is_null($deductibility_limitation)) {
            array_push($this->openAPINullablesSetToNull, 'deductibility_limitation');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deductibility_limitation', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['deductibility_limitation'] = $deductibility_limitation;

        return $this;
    }

    /**
     * Gets deductibility_status_description
     *
     * @return string|null
     */
    public function getDeductibilityStatusDescription()
    {
        return $this->container['deductibility_status_description'];
    }

    /**
     * Sets deductibility_status_description
     *
     * @param string|null $deductibility_status_description deductibility_status_description
     *
     * @return self
     */
    public function setDeductibilityStatusDescription($deductibility_status_description)
    {
        if (is_null($deductibility_status_description)) {
            array_push($this->openAPINullablesSetToNull, 'deductibility_status_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deductibility_status_description', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['deductibility_status_description'] = $deductibility_status_description;
