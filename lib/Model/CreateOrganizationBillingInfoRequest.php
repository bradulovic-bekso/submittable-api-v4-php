<?php
/**
 * CreateOrganizationBillingInfoRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateOrganizationBillingInfoRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrganizationBillingInfoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOrganizationBillingInfoRequest';
    ...
    protected static $openAPITypes = [
        'email' => 'string',
        'name' => 'string',
        'billing_address' => '\OpenAPI\Client\Model\BillingAddressRequest',
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateOrganizationBillingInfoRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateOrganizationBillingInfoRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\BillingAddressRequest
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BillingAddressRequest $billing_address billing_address
     *
     * @return self
     */
