...
/**
 * FormResponseV4FieldsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FormResponseV4FieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormResponseV4_fields_inner';
    ...
    protected static $openAPITypes = [
        ...
        'enable_payment' => 'bool',
        'price' => 'float',
        'options' => '\OpenAPI\Client\Model\OptionResponse[]',
        'enable_branching' => 'bool',
        'inline' => 'bool',
        'file_types' => 'string[]',
        'file_limit' => 'int',
        'metadata' => '\OpenAPI\Client\Model\MetadataResponse[]',
        'table_id' => 'string',
    ...
    protected static $setters = [
        ...
        'table_id' => 'setTableId',
        'table_file_name' => 'setTableFileName',
    ...
    protected static $getters = [
        ...
        'table_id' => 'getTableId',
        'table_file_name' => 'getTableFileName',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('table_file_name', $data ?? [], null);
    ...
    */
    ...
    public function setIsEditable($is_editable)
    {
        if (is_null($is_editable)) {
            array_push($this->openAPINullablesSetToNull, 'is_editable');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_editable', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\OptionResponse[]|null
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\OptionResponse[]|null $options options
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \OpenAPI\Client\Model\MetadataResponse[]|null
     */
     ...
     * Sets metadata
     *
     * @param \OpenAPI\Client\Model\MetadataResponse[]|null $metadata metadata
     *
     * @return self
     */
    ...
    {
        return $this->container['table_file_name'];
    }

    /**
     * Sets table_file_name
     *
     * @param string|null $table_file_name table_file_name
     *
     * @return self
     */
    public function setTableFileName($table_file_name)
    {
        if (is_null($table_file_name)) {
            array_push($this->openAPINullablesSetToNull, 'table_file_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('table_file_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['table_file_name'] = $table_file_name;
     ...
     *
     * @param string|null $reference_form_id reference_form_id
     *
     * @return self
     */
    public function setReferenceFormId($reference_form_id)
    {
        if (is_null($reference_form_id)) {
            array_push($this->openAPINullablesSetToNull, 'reference_form_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reference_form_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
