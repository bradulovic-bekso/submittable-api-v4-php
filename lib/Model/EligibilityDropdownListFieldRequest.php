...
/**
 * EligibilityDropdownListFieldRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EligibilityDropdownListFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EligibilityDropdownListFieldRequest';
    ...
    protected static $openAPITypes = [
        'label' => 'string',
        'options' => '\OpenAPI\Client\Model\OptionRequest[]',
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling EligibilityDropdownListFieldRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\OptionRequest[]|null
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\OptionRequest[]|null $options options
     *
     * @return self
     */
    ...
    public function setFieldType($field_type)
    {
        ...
        if ((mb_strlen($field_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_type when calling EligibilityDropdownListFieldRequest., must be bigger than or equal to 1.');
        }
