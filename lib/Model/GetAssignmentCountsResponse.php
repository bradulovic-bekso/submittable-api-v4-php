...
/**
 * GetAssignmentCountsResponse Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class GetAssignmentCountsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAssignmentCountsResponse';
    ...
    protected static $setters = [
        'assignment_counts' => 'setAssignmentCounts'
    ];
    ...
    protected static $getters = [
        'assignment_counts' => 'getAssignmentCounts'
    ];
    ...
    {
        $this->setIfExists('assignment_counts', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets assignment_counts
     *
     * @return array<string,int>|null
     */
    public function getAssignmentCounts()
    {
        return $this->container['assignment_counts'];
    }

    /**
     * Sets assignment_counts
     *
     * @param array<string,int>|null $assignment_counts assignment_counts
     *
     * @return self
     */
    public function setAssignmentCounts($assignment_counts)
    {
        if (is_null($assignment_counts)) {
            array_push($this->openAPINullablesSetToNull, 'assignment_counts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('assignment_counts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['assignment_counts'] = $assignment_counts;
