    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CreateTransferRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CreateTransferRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateTransferRequest., must be bigger than or equal to 1.');
        }
