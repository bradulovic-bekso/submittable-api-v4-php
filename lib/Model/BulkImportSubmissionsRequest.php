...
/**
 * BulkImportSubmissionsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BulkImportSubmissionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkImportSubmissionsRequest';
    ...
    protected static $openAPITypes = [
        'project_id' => 'string',
        'submissions' => '\OpenAPI\Client\Model\BulkImportSubmissionsRequestSubmissionsInner[]'
    ];
    ...
    */
     ...
     * Gets submissions
     *
     * @return \OpenAPI\Client\Model\BulkImportSubmissionsRequestSubmissionsInner[]|null
     */
     ...
     * Sets submissions
     *
     * @param \OpenAPI\Client\Model\BulkImportSubmissionsRequestSubmissionsInner[]|null $submissions submissions
     *
     * @return self
     */
    public function setSubmissions($submissions)
    {
        if (is_null($submissions)) {
            array_push($this->openAPINullablesSetToNull, 'submissions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('submissions', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
