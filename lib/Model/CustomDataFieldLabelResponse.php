...
/**
 * CustomDataFieldLabelResponse Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class CustomDataFieldLabelResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomDataFieldLabelResponse';
    ...
    protected static $setters = [
        'field_label_id' => 'setFieldLabelId',
        'field_label_name' => 'setFieldLabelName',
    ...
    protected static $getters = [
        'field_label_id' => 'getFieldLabelId',
        'field_label_name' => 'getFieldLabelName',
    ...
    {
        $this->setIfExists('field_label_id', $data ?? [], null);
        $this->setIfExists('field_label_name', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getFieldLabelId()
    {
        return $this->container['field_label_id'];
    }

    /**
     * Sets field_label_id
     *
     * @param string|null $field_label_id field_label_id
     *
     * @return self
     */
    public function setFieldLabelId($field_label_id)
    {
        if (is_null($field_label_id)) {
            array_push($this->openAPINullablesSetToNull, 'field_label_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('field_label_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['field_label_id'] = $field_label_id;

        return $this;
    }

    /**
     * Gets field_label_name
     *
     * @return string|null
     */
    public function getFieldLabelName()
    {
        return $this->container['field_label_name'];
    }

    /**
     * Sets field_label_name
     *
     * @param string|null $field_label_name field_label_name
     *
     * @return self
     */
    public function setFieldLabelName($field_label_name)
    {
        if (is_null($field_label_name)) {
            array_push($this->openAPINullablesSetToNull, 'field_label_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('field_label_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['field_label_name'] = $field_label_name;
