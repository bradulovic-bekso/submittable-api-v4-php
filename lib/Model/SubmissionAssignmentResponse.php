...
/**
 * SubmissionAssignmentResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmissionAssignmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmissionAssignmentResponse';
    ...
    protected static $setters = [
        ...
        'user_id' => 'setUserId',
        'is_review_completed' => 'setIsReviewCompleted'
    ];
    ...
    protected static $getters = [
        ...
        'user_id' => 'getUserId',
        'is_review_completed' => 'getIsReviewCompleted'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_review_completed', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets is_review_completed
     *
     * @return bool|null
     */
    public function getIsReviewCompleted()
    {
        return $this->container['is_review_completed'];
    }

    /**
     * Sets is_review_completed
     *
     * @param bool|null $is_review_completed is_review_completed
     *
     * @return self
     */
    public function setIsReviewCompleted($is_review_completed)
    {
        if (is_null($is_review_completed)) {
            throw new \InvalidArgumentException('non-nullable is_review_completed cannot be null');
        }
        $this->container['is_review_completed'] = $is_review_completed;
