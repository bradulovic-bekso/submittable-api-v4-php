...
/**
 * SubmissionGuidsBaseRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmissionGuidsBaseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmissionGuidsBaseRequest';
    ...
    */
    ...
    public function setSubmissionIds($submission_ids)
    {
        ...
        if ((count($submission_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $submission_ids when calling SubmissionGuidsBaseRequest., number of items must be less than or equal to 500.');
        }
        if ((count($submission_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $submission_ids when calling SubmissionGuidsBaseRequest., number of items must be greater than or equal to 1.');
        }
