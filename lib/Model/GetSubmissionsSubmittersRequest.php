...
/**
 * GetSubmissionsSubmittersRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class GetSubmissionsSubmittersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSubmissionsSubmittersRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['submission_ids']) && (count($this->container['submission_ids']) > 500)) {
            $invalidProperties[] = "invalid value for 'submission_ids', number of items must be less than or equal to 500.";
        }

        if (!is_null($this->container['submission_ids']) && (count($this->container['submission_ids']) < 1)) {
    ...
    public function setSubmissionIds($submission_ids)
    {
        if (is_null($submission_ids)) {
            array_push($this->openAPINullablesSetToNull, 'submission_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('submission_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        if (!is_null($submission_ids) && (count($submission_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $submission_ids when calling GetSubmissionsSubmittersRequest., number of items must be less than or equal to 500.');
        }
        if (!is_null($submission_ids) && (count($submission_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $submission_ids when calling GetSubmissionsSubmittersRequest., number of items must be greater than or equal to 1.');
        }
