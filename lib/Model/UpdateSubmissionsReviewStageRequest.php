<?php
/**
 * UpdateSubmissionsReviewStageRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateSubmissionsReviewStageRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSubmissionsReviewStageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSubmissionsReviewStageRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['review_stage_id'] === null) {
            $invalidProperties[] = "'review_stage_id' can't be null";
        }
     ...
     *
     * @param string $review_stage_id review_stage_id
     *
     * @return self
     */
    ...
    public function setSubmissionIds($submission_ids)
    {
        ...
        if ((count($submission_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $submission_ids when calling UpdateSubmissionsReviewStageRequest., number of items must be less than or equal to 500.');
        }
        if ((count($submission_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $submission_ids when calling UpdateSubmissionsReviewStageRequest., number of items must be greater than or equal to 1.');
        }
