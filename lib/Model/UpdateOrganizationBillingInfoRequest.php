...
/**
 * UpdateOrganizationBillingInfoRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateOrganizationBillingInfoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateOrganizationBillingInfoRequest';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UpdateOrganizationBillingInfoRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateOrganizationBillingInfoRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\BillingAddressRequest|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BillingAddressRequest|null $billing_address billing_address
     *
     * @return self
     */
