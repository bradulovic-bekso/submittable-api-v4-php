<?php
/**
 * SubmissionPublicOrganizationUpdateItem
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SubmissionPublicOrganizationUpdateItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmissionPublicOrganizationUpdateItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmissionPublicOrganizationUpdateItem';
    ...
    */
    ...
    public function setOrgVersion($org_version)
    {
        if (is_null($org_version)) {
            array_push($this->openAPINullablesSetToNull, 'org_version');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('org_version', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
