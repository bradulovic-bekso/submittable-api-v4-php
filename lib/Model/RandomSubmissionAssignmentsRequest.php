<?php
/**
 * RandomSubmissionAssignmentsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RandomSubmissionAssignmentsRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class RandomSubmissionAssignmentsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RandomSubmissionAssignmentsRequest';
    ...
    protected static $openAPIFormats = [
        'reviewers_per_submission' => 'int32',
        'team_member_pool' => 'uuid',
        'internal_note' => null,
        'submission_ids' => 'uuid'
    ];
    ...
    protected static array $openAPINullables = [
        'reviewers_per_submission' => false,
        'team_member_pool' => false,
        'internal_note' => true,
    ...
    protected static $attributeMap = [
        ...
        'team_member_pool' => 'teamMemberPool',
    ...
    protected static $setters = [
        'reviewers_per_submission' => 'setReviewersPerSubmission',
        'team_member_pool' => 'setTeamMemberPool',
    ...
    protected static $getters = [
        'reviewers_per_submission' => 'getReviewersPerSubmission',
        'team_member_pool' => 'getTeamMemberPool',
    ...
    {
        $this->setIfExists('reviewers_per_submission', $data ?? [], null);
        $this->setIfExists('team_member_pool', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reviewers_per_submission'] === null) {
            $invalidProperties[] = "'reviewers_per_submission' can't be null";
        }
        if ($this->container['team_member_pool'] === null) {
            $invalidProperties[] = "'team_member_pool' can't be null";
        }
        if ((count($this->container['team_member_pool']) < 1)) {
            $invalidProperties[] = "invalid value for 'team_member_pool', number of items must be greater than or equal to 1.";
        }
    ...
    /**
     * Gets reviewers_per_submission
     *
     * @return int
     */
    public function getReviewersPerSubmission()
    {
        return $this->container['reviewers_per_submission'];
    }

    /**
     * Sets reviewers_per_submission
     *
     * @param int $reviewers_per_submission reviewers_per_submission
     *
     * @return self
     */
    public function setReviewersPerSubmission($reviewers_per_submission)
    {
        if (is_null($reviewers_per_submission)) {
            throw new \InvalidArgumentException('non-nullable reviewers_per_submission cannot be null');
        }
        $this->container['reviewers_per_submission'] = $reviewers_per_submission;

        return $this;
    }

    /**
     * Gets team_member_pool
     *
     * @return string[]
     */
    public function getTeamMemberPool()
    {
        return $this->container['team_member_pool'];
    }

    /**
     * Sets team_member_pool
     *
     * @param string[] $team_member_pool team_member_pool
     *
     * @return self
     */
    public function setTeamMemberPool($team_member_pool)
    {
        if (is_null($team_member_pool)) {
            throw new \InvalidArgumentException('non-nullable team_member_pool cannot be null');
        }


        if ((count($team_member_pool) < 1)) {
            throw new \InvalidArgumentException('invalid length for $team_member_pool when calling RandomSubmissionAssignmentsRequest., number of items must be greater than or equal to 1.');
        }
        $this->container['team_member_pool'] = $team_member_pool;
    ...
    public function setSubmissionIds($submission_ids)
    {
        ...
        if ((count($submission_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $submission_ids when calling RandomSubmissionAssignmentsRequest., number of items must be less than or equal to 500.');
        }
        if ((count($submission_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $submission_ids when calling RandomSubmissionAssignmentsRequest., number of items must be greater than or equal to 1.');
        }
