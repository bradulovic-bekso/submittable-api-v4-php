...
/**
 * PostFileDataResponse Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class PostFileDataResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostFileDataResponse';
    ...
    protected static $openAPITypes = [
        'file' => '\Submittable\Model\FileResponse',
        'post_data' => 'array<string,mixed>',
        'put_headers' => 'array<string,string>',
        'upload_url' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('post_data', $data ?? [], null);
        $this->setIfExists('put_headers', $data ?? [], null);
    ...
    */
     ...
     * Gets file
     *
     * @return \Submittable\Model\FileResponse|null
     */
     ...
     * Sets file
     *
     * @param \Submittable\Model\FileResponse|null $file file
     *
     * @return self
     */
     ...
     * Sets post_data
     *
     * @param array<string,mixed>|null $post_data post_data
     *
     * @return self
     */
    public function setPostData($post_data)
    {
        if (is_null($post_data)) {
            array_push($this->openAPINullablesSetToNull, 'post_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('post_data', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     */
    public function getPutHeaders()
    {
        return $this->container['put_headers'];
    }

    /**
     * Sets put_headers
     *
     * @param array<string,string>|null $put_headers put_headers
     *
     * @return self
     */
    public function setPutHeaders($put_headers)
    {
        if (is_null($put_headers)) {
            array_push($this->openAPINullablesSetToNull, 'put_headers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('put_headers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['put_headers'] = $put_headers;
