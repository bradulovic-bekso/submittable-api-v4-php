<?php
/**
 * CoverLetterFieldResponseRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CoverLetterFieldResponseRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class CoverLetterFieldResponseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CoverLetterFieldResponseRequest';
    ...
    */
    ...
    public function setFieldType($field_type)
    {
        ...
        if ((mb_strlen($field_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_type when calling CoverLetterFieldResponseRequest., must be bigger than or equal to 1.');
        }
