...
class PaymentReceipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'payment_lines' => '\OpenAPI\Client\Model\PaymentLine[]',
        'total' => 'float'
    ];
    ...
    */
     ...
     * Gets payment_lines
     *
     * @return \OpenAPI\Client\Model\PaymentLine[]|null
     */
     ...
     * Sets payment_lines
     *
     * @param \OpenAPI\Client\Model\PaymentLine[]|null $payment_lines payment_lines
     *
     * @return self
     */
    public function setPaymentLines($payment_lines)
    {
        if (is_null($payment_lines)) {
            array_push($this->openAPINullablesSetToNull, 'payment_lines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payment_lines', $nullablesSetToNull);
            if ($index !== FALSE) {
