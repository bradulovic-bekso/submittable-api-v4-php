...
/**
 * V4TransactionsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class V4TransactionsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'transaction_status';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v4_transactions_post_request';
    ...
    protected static $attributeMap = [
        ...
        'award_transaction_id' => 'awardTransactionId'
    ];
    ...
    protected static $setters = [
        ...
        'award_transaction_id' => 'setAwardTransactionId'
    ];
    ...
    protected static $getters = [
        ...
        'award_transaction_id' => 'getAwardTransactionId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('award_transaction_id', $data ?? [], null);

        // Initialize discriminator property with the model name.
        $this->container['transaction_status'] = static::$openAPIModelName;
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fund_id'] === null) {
            $invalidProperties[] = "'fund_id' can't be null";
        }
        ...
        if ($this->container['award_transaction_id'] === null) {
            $invalidProperties[] = "'award_transaction_id' can't be null";
        }
    ...
    {
        if (is_null($fund_id)) {
            throw new \InvalidArgumentException('non-nullable fund_id cannot be null');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 9999999999.99)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling V4TransactionsPostRequest., must be smaller than or equal to 9999999999.99.');
        }
        if (($amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling V4TransactionsPostRequest., must be bigger than or equal to 0.01.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling V4TransactionsPostRequest., must be smaller than or equal to 500.');
        }
    ...
    public function setApplicantMemo($applicant_memo)
    {
        ...
        if (!is_null($applicant_memo) && (mb_strlen($applicant_memo) > 500)) {
            throw new \InvalidArgumentException('invalid length for $applicant_memo when calling V4TransactionsPostRequest., must be smaller than or equal to 500.');
        }
    ...
    /**
     * Gets award_transaction_id
     *
     * @return string
     */
    public function getAwardTransactionId()
    {
        return $this->container['award_transaction_id'];
    }

    /**
     * Sets award_transaction_id
     *
     * @param string $award_transaction_id award_transaction_id
     *
     * @return self
     */
    public function setAwardTransactionId($award_transaction_id)
    {
        if (is_null($award_transaction_id)) {
            throw new \InvalidArgumentException('non-nullable award_transaction_id cannot be null');
        }
        $this->container['award_transaction_id'] = $award_transaction_id;
