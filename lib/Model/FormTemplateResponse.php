...
/**
 * FormTemplateResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FormTemplateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormTemplateResponse';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'type' => 'string',
        'fields' => '\OpenAPI\Client\Model\FormResponseV4FieldsInner[]',
        'branches' => '\OpenAPI\Client\Model\BranchResponse[]',
        'blocks' => '\OpenAPI\Client\Model\BlockResponse[]'
    ];
    ...
    */
    ...
    public function setFormTemplateId($form_template_id)
    {
        if (is_null($form_template_id)) {
            ...
            $index = array_search('form_template_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets fields
     *
     * @return \OpenAPI\Client\Model\FormResponseV4FieldsInner[]|null
     */
     ...
     * Sets fields
     *
     * @param \OpenAPI\Client\Model\FormResponseV4FieldsInner[]|null $fields fields
     *
     * @return self
     */
     ...
     * Gets branches
     *
     * @return \OpenAPI\Client\Model\BranchResponse[]|null
     */
     ...
     * Sets branches
     *
     * @param \OpenAPI\Client\Model\BranchResponse[]|null $branches branches
     *
     * @return self
     */
     ...
     * Gets blocks
     *
     * @return \OpenAPI\Client\Model\BlockResponse[]|null
     */
     ...
     * Sets blocks
     *
     * @param \OpenAPI\Client\Model\BlockResponse[]|null $blocks blocks
     *
     * @return self
     */
