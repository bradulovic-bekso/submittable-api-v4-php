...
/**
 * FileUploadFieldRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FileUploadFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileUploadFieldRequest';
    ...
    protected static $openAPITypes = [
        ...
        'file_types' => 'string[]',
        'file_limit' => 'int',
        'metadata' => '\OpenAPI\Client\Model\MetadataRequest[]',
        'enable_payment' => 'bool',
        'price' => 'float',
        'is_concealed' => 'bool',
        'field_type' => 'string',
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling FileUploadFieldRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets metadata
     *
     * @return \OpenAPI\Client\Model\MetadataRequest[]|null
     */
     ...
     * Sets metadata
     *
     * @param \OpenAPI\Client\Model\MetadataRequest[]|null $metadata metadata
     *
     * @return self
     */
    ...
    public function setFieldType($field_type)
    {
        ...
        if ((mb_strlen($field_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_type when calling FileUploadFieldRequest., must be bigger than or equal to 1.');
        }
