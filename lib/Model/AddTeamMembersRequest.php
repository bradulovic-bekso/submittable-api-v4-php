...
/**
 * AddTeamMembersRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class AddTeamMembersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddTeamMembersRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['emails']) > 500)) {
            $invalidProperties[] = "invalid value for 'emails', number of items must be less than or equal to 500.";
        }
    ...
    public function setEmails($emails)
    {
        ...
        if ((count($emails) > 500)) {
            throw new \InvalidArgumentException('invalid value for $emails when calling AddTeamMembersRequest., number of items must be less than or equal to 500.');
        }
        if ((count($emails) < 1)) {
            throw new \InvalidArgumentException('invalid length for $emails when calling AddTeamMembersRequest., number of items must be greater than or equal to 1.');
        }
