...
/**
 * GetSubmissionsRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class GetSubmissionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSubmissionsRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['submission_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'submission_ids', number of items must be less than or equal to 1000.";
        }
    ...
    public function setSubmissionIds($submission_ids)
    {
        ...
        if ((count($submission_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $submission_ids when calling GetSubmissionsRequest., number of items must be less than or equal to 1000.');
        }
