...
/**
 * GetTeamMembersResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTeamMembersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTeamMembersResponse';
    ...
    protected static $openAPITypes = [
        'team_members' => '\OpenAPI\Client\Model\GetTeamMemberResponse[]'
    ];
    ...
    */
     ...
     * Gets team_members
     *
     * @return \OpenAPI\Client\Model\GetTeamMemberResponse[]|null
     */
     ...
     * Sets team_members
     *
     * @param \OpenAPI\Client\Model\GetTeamMemberResponse[]|null $team_members team_members
     *
     * @return self
     */
    public function setTeamMembers($team_members)
    {
        if (is_null($team_members)) {
            array_push($this->openAPINullablesSetToNull, 'team_members');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('team_members', $nullablesSetToNull);
            if ($index !== FALSE) {
