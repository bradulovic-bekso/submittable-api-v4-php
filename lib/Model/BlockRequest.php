 ...
 */
class BlockRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const BLOCK_TYPE_PAYMENT = 'payment';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('block_type', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['block_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'block_id', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['block_type'] === null) {
            $invalidProperties[] = "'block_type' can't be null";
        }
        ...
        if (!is_null($this->container['block_type']) && !in_array($this->container['block_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'block_type', must be one of '%s'",
                $this->container['block_type'],
    ...
    public function setBlockId($block_id)
    {
        ...
        if ((mb_strlen($block_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $block_id when calling BlockRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets block_type
     *
     * @param string $block_type block_type
     *
     * @return self
     */
    public function setBlockType($block_type)
    {
        if (is_null($block_type)) {
            throw new \InvalidArgumentException('non-nullable block_type cannot be null');
        }
        $allowedValues = $this->getBlockTypeAllowableValues();
        if (!in_array($block_type, $allowedValues, true)) {
