...
/**
 * AdditionalFormEntryResponseFieldDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdditionalFormEntryResponseFieldDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdditionalFormEntryResponse_fieldData_inner';
    ...
    protected static $openAPITypes = [
        ...
        'longitude' => 'string',
        'options' => 'string[]',
        'files' => '\OpenAPI\Client\Model\ApiFieldDataFileUploadValueFileResponse[]',
        'table' => '\OpenAPI\Client\Model\FieldDataTableValueResponse',
        'referee_email' => 'string',
        'personal_message' => 'string',
        'reference_form_entry_id' => 'string',
        'ein' => 'string',
        'status_code' => '\OpenAPI\Client\Model\HttpStatusCode',
        ...
        'email' => 'string',
        'session_url' => 'string',
        'verification_status' => '\OpenAPI\Client\Model\IdVerificationStatus',
        'verification_status_string' => 'string',
        'verification_data' => '\OpenAPI\Client\Model\IdVerificationDetails',
    ...
    protected static $attributeMap = [
        ...
        'reference_form_entry_id' => 'referenceFormEntryId',
        'ein' => 'ein',
    ...
    protected static $setters = [
        ...
        'reference_form_entry_id' => 'setReferenceFormEntryId',
        'ein' => 'setEin',
    ...
    protected static $getters = [
        ...
        'reference_form_entry_id' => 'getReferenceFormEntryId',
        'ein' => 'getEin',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('reference_form_entry_id', $data ?? [], null);
    ...
    */
    ...
    public function setFieldType($field_type)
    {
        ...
        if ((mb_strlen($field_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_type when calling AdditionalFormEntryResponseFieldDataInner., must be bigger than or equal to 1.');
        }
     ...
     * Gets files
     *
     * @return \OpenAPI\Client\Model\ApiFieldDataFileUploadValueFileResponse[]|null
     */
     ...
     * Sets files
     *
     * @param \OpenAPI\Client\Model\ApiFieldDataFileUploadValueFileResponse[]|null $files files
     *
     * @return self
     */
     ...
     * Gets table
     *
     * @return \OpenAPI\Client\Model\FieldDataTableValueResponse|null
     */
     ...
     * Sets table
     *
     * @param \OpenAPI\Client\Model\FieldDataTableValueResponse|null $table table
     *
     * @return self
     */
    ...
    /**
     * Gets reference_form_entry_id
     *
     * @return string|null
     */
    public function getReferenceFormEntryId()
    {
        return $this->container['reference_form_entry_id'];
    }

    /**
     * Sets reference_form_entry_id
     *
     * @param string|null $reference_form_entry_id reference_form_entry_id
     *
     * @return self
     */
    public function setReferenceFormEntryId($reference_form_entry_id)
    {
        if (is_null($reference_form_entry_id)) {
            array_push($this->openAPINullablesSetToNull, 'reference_form_entry_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reference_form_entry_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['reference_form_entry_id'] = $reference_form_entry_id;
     ...
     * Gets status_code
     *
     * @return \OpenAPI\Client\Model\HttpStatusCode|null
     */
     ...
     * Sets status_code
     *
     * @param \OpenAPI\Client\Model\HttpStatusCode|null $status_code status_code
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\IdVerificationStatus|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\IdVerificationStatus|null $verification_status verification_status
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\IdVerificationDetails|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\IdVerificationDetails|null $verification_data verification_data
     *
     * @return self
     */
