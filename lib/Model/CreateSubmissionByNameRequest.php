...
/**
 * CreateSubmissionByNameRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSubmissionByNameRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSubmissionByNameRequest';
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CreateSubmissionByNameRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CreateSubmissionByNameRequest., must be bigger than or equal to 1.');
        }
