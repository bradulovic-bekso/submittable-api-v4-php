...
/**
 * OrganizationSearchAgency Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class OrganizationSearchAgency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationSearchAgency';
    ...
    protected static $setters = [
        ...
        'data_source_filters' => 'setDataSourceFilters'
    ];
    ...
    protected static $getters = [
        ...
        'data_source_filters' => 'getDataSourceFilters'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('data_source_filters', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets region_label
     *
     * @param string|null $region_label region_label
     *
     * @return self
     */
    public function setRegionLabel($region_label)
    {
        if (is_null($region_label)) {
            array_push($this->openAPINullablesSetToNull, 'region_label');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('region_label', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets data_source_filters
     *
     * @return string[]|null
     */
    public function getDataSourceFilters()
    {
        return $this->container['data_source_filters'];
    }

    /**
     * Sets data_source_filters
     *
     * @param string[]|null $data_source_filters data_source_filters
     *
     * @return self
     */
    public function setDataSourceFilters($data_source_filters)
    {
        if (is_null($data_source_filters)) {
            array_push($this->openAPINullablesSetToNull, 'data_source_filters');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('data_source_filters', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['data_source_filters'] = $data_source_filters;
