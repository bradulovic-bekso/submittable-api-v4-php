...
/**
 * UpdateTeamMembersRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTeamMembersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTeamMembersRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['user_ids']) > 500)) {
            $invalidProperties[] = "invalid value for 'user_ids', number of items must be less than or equal to 500.";
        }

        if ((count($this->container['user_ids']) < 1)) {
            $invalidProperties[] = "invalid value for 'user_ids', number of items must be greater than or equal to 1.";
        }
    ...
    public function setUserIds($user_ids)
    {
        ...
        if ((count($user_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $user_ids when calling UpdateTeamMembersRequest., number of items must be less than or equal to 500.');
        }
        if ((count($user_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_ids when calling UpdateTeamMembersRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setPermissionLevel($permission_level)
    {
        if (is_null($permission_level)) {
            array_push($this->openAPINullablesSetToNull, 'permission_level');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('permission_level', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getPermissionLevelAllowableValues();
        if (!is_null($permission_level) && !in_array($permission_level, $allowedValues, true)) {
