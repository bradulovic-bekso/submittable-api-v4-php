...
/**
 * EmailFieldRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailFieldRequest';
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling EmailFieldRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFieldType($field_type)
    {
        ...
        if ((mb_strlen($field_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_type when calling EmailFieldRequest., must be bigger than or equal to 1.');
        }
