...
/**
 * TitleFieldRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class TitleFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TitleFieldRequest';
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling TitleFieldRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCountLimit($count_limit)
    {
        if (is_null($count_limit)) {
            throw new \InvalidArgumentException('non-nullable count_limit cannot be null');
        }
    ...
    public function setFieldType($field_type)
    {
        ...
        if ((mb_strlen($field_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_type when calling TitleFieldRequest., must be bigger than or equal to 1.');
        }
