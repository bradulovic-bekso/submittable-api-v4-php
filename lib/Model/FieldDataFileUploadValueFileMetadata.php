<?php
/**
 * FieldDataFileUploadValueFileMetadata
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FieldDataFileUploadValueFileMetadata Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FieldDataFileUploadValueFileMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FieldDataFileUploadValueFileMetadata';
    ...
    protected static $attributeMap = [
        'form_metadata_id' => 'formMetadataId',
        'value' => 'value'
    ];
    ...
    protected static $setters = [
        'form_metadata_id' => 'setFormMetadataId',
        'value' => 'setValue'
    ];
    ...
    protected static $getters = [
        'form_metadata_id' => 'getFormMetadataId',
        'value' => 'getValue'
    ];
    ...
    {
        $this->setIfExists('form_metadata_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets form_metadata_id
     *
     * @return string|null
     */
    public function getFormMetadataId()
    {
        return $this->container['form_metadata_id'];
    }

    /**
     * Sets form_metadata_id
     *
     * @param string|null $form_metadata_id form_metadata_id
     *
     * @return self
     */
    public function setFormMetadataId($form_metadata_id)
    {
        if (is_null($form_metadata_id)) {
            array_push($this->openAPINullablesSetToNull, 'form_metadata_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('form_metadata_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['form_metadata_id'] = $form_metadata_id;
