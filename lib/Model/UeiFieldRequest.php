...
/**
 * UeiFieldRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class UeiFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UeiFieldRequest';
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling UeiFieldRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFieldType($field_type)
    {
        ...
        if ((mb_strlen($field_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_type when calling UeiFieldRequest., must be bigger than or equal to 1.');
        }
