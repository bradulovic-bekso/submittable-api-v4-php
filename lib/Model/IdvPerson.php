 ...
 */
class IdvPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdvPerson';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dateof_birth', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['dateof_birth'];
    }

    /**
     * Sets dateof_birth
     *
     * @param \DateTime|null $dateof_birth dateof_birth
     *
     * @return self
     */
    public function setDateofBirth($dateof_birth)
    {
        if (is_null($dateof_birth)) {
            array_push($this->openAPINullablesSetToNull, 'dateof_birth');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dateof_birth', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['dateof_birth'] = $dateof_birth;
