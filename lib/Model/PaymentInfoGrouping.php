...
/**
 * PaymentInfoGrouping Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentInfoGrouping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInfoGrouping';
    ...
    protected static $openAPITypes = [
        'description' => 'string',
        'items' => '\OpenAPI\Client\Model\PaymentInfo[]'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\PaymentInfo[]|null $items items
     *
     * @return self
     */
