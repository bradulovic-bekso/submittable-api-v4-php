...
/**
 * GalleryFieldResponse Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class GalleryFieldResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GalleryFieldResponse';
    ...
    protected static $openAPITypes = [
        ...
        'public_view' => 'bool',
        'allow_filter' => 'bool',
        'display_filter_short_name' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'public_view' => null,
        'allow_filter' => null,
        'display_filter_short_name' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'public_view' => false,
        'allow_filter' => false,
        'display_filter_short_name' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'display_filter_short_name' => 'displayFilterShortName'
    ];
    ...
    protected static $setters = [
        'field_id' => 'setFieldId',
        'public_view' => 'setPublicView',
        'allow_filter' => 'setAllowFilter',
        'display_filter_short_name' => 'setDisplayFilterShortName'
    ];
    ...
    protected static $getters = [
        'field_id' => 'getFieldId',
        'public_view' => 'getPublicView',
        'allow_filter' => 'getAllowFilter',
        'display_filter_short_name' => 'getDisplayFilterShortName'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('public_view', $data ?? [], null);
        $this->setIfExists('allow_filter', $data ?? [], null);
        $this->setIfExists('display_filter_short_name', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['public_view'];
    }

    /**
     * Sets public_view
     *
     * @param bool|null $public_view public_view
     *
     * @return self
     */
    public function setPublicView($public_view)
    {
        if (is_null($public_view)) {
            throw new \InvalidArgumentException('non-nullable public_view cannot be null');
        }
        $this->container['public_view'] = $public_view;
    ...
    {
        return $this->container['allow_filter'];
    }

    /**
     * Sets allow_filter
     *
     * @param bool|null $allow_filter allow_filter
     *
     * @return self
     */
    public function setAllowFilter($allow_filter)
    {
        if (is_null($allow_filter)) {
            throw new \InvalidArgumentException('non-nullable allow_filter cannot be null');
        }
        $this->container['allow_filter'] = $allow_filter;

        return $this;
    }

    /**
     * Gets display_filter_short_name
     *
     * @return string|null
     */
    public function getDisplayFilterShortName()
    {
        return $this->container['display_filter_short_name'];
    }

    /**
     * Sets display_filter_short_name
     *
     * @param string|null $display_filter_short_name display_filter_short_name
     *
     * @return self
     */
    public function setDisplayFilterShortName($display_filter_short_name)
    {
        if (is_null($display_filter_short_name)) {
            array_push($this->openAPINullablesSetToNull, 'display_filter_short_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('display_filter_short_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['display_filter_short_name'] = $display_filter_short_name;
