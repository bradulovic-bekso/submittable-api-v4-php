...
/**
 * CreatePendingTransactionRequest Class Doc Comment
 *
 * @category Class
 * @package  Submittable
 * @author   OpenAPI Generator team
 ...
 */
class CreatePendingTransactionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePendingTransactionRequest';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 9999999999.99)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreatePendingTransactionRequest., must be smaller than or equal to 9999999999.99.');
        }
        if (($amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreatePendingTransactionRequest., must be bigger than or equal to 0.01.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreatePendingTransactionRequest., must be smaller than or equal to 500.');
        }
    ...
    public function setApplicantMemo($applicant_memo)
    {
        ...
        if (!is_null($applicant_memo) && (mb_strlen($applicant_memo) > 500)) {
            throw new \InvalidArgumentException('invalid length for $applicant_memo when calling CreatePendingTransactionRequest., must be smaller than or equal to 500.');
        }
