...
class PaymentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'is_submission_fee' => 'isSubmissionFee'
    ];
    ...
    protected static $setters = [
        ...
        'is_submission_fee' => 'setIsSubmissionFee'
    ];
    ...
    protected static $getters = [
        ...
        'is_submission_fee' => 'getIsSubmissionFee'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_submission_fee', $data ?? [], null);
    }
    ...
    */
    ...
    public function setPriceDisplay($price_display)
    {
        if (is_null($price_display)) {
            array_push($this->openAPINullablesSetToNull, 'price_display');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('price_display', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets is_submission_fee
     *
     * @return bool|null
     */
    public function getIsSubmissionFee()
    {
        return $this->container['is_submission_fee'];
    }

    /**
     * Sets is_submission_fee
     *
     * @param bool|null $is_submission_fee is_submission_fee
     *
     * @return self
     */
    public function setIsSubmissionFee($is_submission_fee)
    {
        if (is_null($is_submission_fee)) {
            throw new \InvalidArgumentException('non-nullable is_submission_fee cannot be null');
        }
        $this->container['is_submission_fee'] = $is_submission_fee;
