...
/**
 * CustomDataLabelsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomDataLabelsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomDataLabelsResponse';
    ...
    protected static $openAPITypes = [
        ...
        'field_labels' => '\OpenAPI\Client\Model\CustomDataFieldLabelResponse[]',
        'created_on' => '\DateTime',
        'created_by' => 'string',
        'updated_on' => '\DateTime',
        'updated_by' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('field_labels', $data ?? [], null);
    ...
    */
     ...
     * Gets field_labels
     *
     * @return \OpenAPI\Client\Model\CustomDataFieldLabelResponse[]|null
     */
     ...
     * Sets field_labels
     *
     * @param \OpenAPI\Client\Model\CustomDataFieldLabelResponse[]|null $field_labels field_labels
     *
     * @return self
     */
    public function setFieldLabels($field_labels)
    {
        if (is_null($field_labels)) {
            array_push($this->openAPINullablesSetToNull, 'field_labels');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('field_labels', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['field_labels'] = $field_labels;
