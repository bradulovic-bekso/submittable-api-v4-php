...
/**
 * CustomDataRecordRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomDataRecordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomDataRecordRequest';
    ...
    protected static $openAPITypes = [
        ...
        'custom_data' => '\OpenAPI\Client\Model\CustomDataField[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['public_organization_id'] === null) {
            $invalidProperties[] = "'public_organization_id' can't be null";
        }
        if ($this->container['custom_data'] === null) {
            $invalidProperties[] = "'custom_data' can't be null";
        }
        if ((count($this->container['custom_data']) > 100)) {
            $invalidProperties[] = "invalid value for 'custom_data', number of items must be less than or equal to 100.";
        }

        if ((count($this->container['custom_data']) < 1)) {
            $invalidProperties[] = "invalid value for 'custom_data', number of items must be greater than or equal to 1.";
        }
     ...
     *
     * @param string $public_organization_id public_organization_id
     *
     * @return self
     */
    public function setPublicOrganizationId($public_organization_id)
    {
        if (is_null($public_organization_id)) {
            throw new \InvalidArgumentException('non-nullable public_organization_id cannot be null');
        }
     ...
     * Gets custom_data
     *
     * @return \OpenAPI\Client\Model\CustomDataField[]
     */
     ...
     * Sets custom_data
     *
     * @param \OpenAPI\Client\Model\CustomDataField[] $custom_data custom_data
     *
     * @return self
     */
    public function setCustomData($custom_data)
    {
        ...
        if ((count($custom_data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $custom_data when calling CustomDataRecordRequest., number of items must be less than or equal to 100.');
        }
        if ((count($custom_data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $custom_data when calling CustomDataRecordRequest., number of items must be greater than or equal to 1.');
        }
