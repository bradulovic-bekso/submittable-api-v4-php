...
/**
 * SyncPlaceholdersResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SyncPlaceholdersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SyncPlaceholdersResponse';
    ...
    */
    ...
    public function setPlaceholderId($placeholder_id)
    {
        if (is_null($placeholder_id)) {
            array_push($this->openAPINullablesSetToNull, 'placeholder_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('placeholder_id', $nullablesSetToNull);
            if ($index !== FALSE) {
