...
/**
 * AdditionalFormsStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class AdditionalFormsStatus
{
    ...
    public const ALL_COMPLETED = 'allCompleted';

    public const NONE_COMPLETED = 'noneCompleted';

    public const ANY_EDITABLE = 'anyEditable';
