...
class ApiFieldDataFileUploadValueFileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'file_id' => 'string',
        'metadata' => '\Submittable\Model\ApiFieldDataFileUploadValueFileMetadata[]',
        'file_name' => 'string',
        'type' => 'string',
    ...
    */
     ...
     * Gets metadata
     *
     * @return \Submittable\Model\ApiFieldDataFileUploadValueFileMetadata[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Submittable\Model\ApiFieldDataFileUploadValueFileMetadata[]|null $metadata metadata
     *
     * @return self
     */
