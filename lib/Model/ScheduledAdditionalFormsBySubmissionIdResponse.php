<?php
/**
 * ScheduledAdditionalFormsBySubmissionIdResponse
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ScheduledAdditionalFormsBySubmissionIdResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScheduledAdditionalFormsBySubmissionIdResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduledAdditionalFormsBySubmissionIdResponse';
    ...
    protected static $openAPITypes = [
        'scheduled_additional_forms' => '\OpenAPI\Client\Model\ScheduledAdditionalFormBySubmissionResponse[]'
    ];
    ...
    protected static $openAPIFormats = [
        'scheduled_additional_forms' => null
    ];
    ...
    protected static array $openAPINullables = [
        'scheduled_additional_forms' => true
    ];
    ...
    protected static $attributeMap = [
        'scheduled_additional_forms' => 'scheduledAdditionalForms'
    ];
    ...
    protected static $setters = [
        'scheduled_additional_forms' => 'setScheduledAdditionalForms'
    ];
    ...
    protected static $getters = [
        'scheduled_additional_forms' => 'getScheduledAdditionalForms'
    ];
    ...
    {
        $this->setIfExists('scheduled_additional_forms', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets scheduled_additional_forms
     *
     * @return \OpenAPI\Client\Model\ScheduledAdditionalFormBySubmissionResponse[]|null
     */
    public function getScheduledAdditionalForms()
    {
        return $this->container['scheduled_additional_forms'];
    }

    /**
     * Sets scheduled_additional_forms
     *
     * @param \OpenAPI\Client\Model\ScheduledAdditionalFormBySubmissionResponse[]|null $scheduled_additional_forms scheduled_additional_forms
     *
     * @return self
     */
    public function setScheduledAdditionalForms($scheduled_additional_forms)
    {
        if (is_null($scheduled_additional_forms)) {
            array_push($this->openAPINullablesSetToNull, 'scheduled_additional_forms');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('scheduled_additional_forms', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['scheduled_additional_forms'] = $scheduled_additional_forms;
