...
/**
 * RescindAdditionalFormsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RescindAdditionalFormsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RescindAdditionalFormsRequest';
    ...
    */
    ...
    public function setEntryIds($entry_ids)
    {
        ...
        if ((count($entry_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $entry_ids when calling RescindAdditionalFormsRequest., number of items must be less than or equal to 500.');
        }
        if ((count($entry_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $entry_ids when calling RescindAdditionalFormsRequest., number of items must be greater than or equal to 1.');
        }
