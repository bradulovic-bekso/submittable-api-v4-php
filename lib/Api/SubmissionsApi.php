...
class SubmissionsApi
{
     ...
     * @return \Submittable\Model\BadRequestResponse|\Submittable\Model\SubmissionResponse
     */
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\BadRequestResponse|\Submittable\Model\SubmissionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubmissionWithHttpInfo($submission_id, string $contentType = self::contentTypes['getSubmission'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Submittable\Model\SubmissionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\SubmissionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\SubmissionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\SubmissionResponse';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\SubmissionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Get submissions
     *
     * @param  \Submittable\Model\GetSubmissionsRequest|null $get_submissions_request get_submissions_request (optional)
     ...
     * Get submissions
     *
     * @param  \Submittable\Model\GetSubmissionsRequest|null $get_submissions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSubmissions'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Submittable\Model\ExternalSubmissionRequest|null $external_submission_request external_submission_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\ExternalSubmissionResponse|\Submittable\Model\BadRequestResponse
     */
     ...
     * Create external submission
     *
     * @param  \Submittable\Model\ExternalSubmissionRequest|null $external_submission_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4MySubmissionsExternalPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\ExternalSubmissionResponse|\Submittable\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4MySubmissionsExternalPostWithHttpInfo($external_submission_request = null, string $contentType = self::contentTypes['v4MySubmissionsExternalPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Submittable\Model\ExternalSubmissionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\ExternalSubmissionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\ExternalSubmissionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Submittable\Model\ExternalSubmissionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\ExternalSubmissionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Submittable\Model\SubmissionGuidsBaseRequest|null $submission_guids_base_request submission_guids_base_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\ListSubmissionAssignmentsResponse
     */
     ...
     * Get submission assignments organized by userId
     *
     * @param  \Submittable\Model\SubmissionGuidsBaseRequest|null $submission_guids_base_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsAssignmentsListPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\ListSubmissionAssignmentsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsAssignmentsListPostWithHttpInfo($submission_guids_base_request = null, string $contentType = self::contentTypes['v4SubmissionsAssignmentsListPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\ListSubmissionAssignmentsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\ListSubmissionAssignmentsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\ListSubmissionAssignmentsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\ListSubmissionAssignmentsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\ListSubmissionAssignmentsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Submittable\Model\UpdateSubmissionsAssignmentsRequest|null $update_submissions_assignments_request update_submissions_assignments_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\UpdateSubmissionAssignmentsApiResponse
     */
     ...
     * Update assignments on submissions
     *
     * @param  \Submittable\Model\UpdateSubmissionsAssignmentsRequest|null $update_submissions_assignments_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsAssignmentsPut'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\UpdateSubmissionAssignmentsApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsAssignmentsPutWithHttpInfo($update_submissions_assignments_request = null, string $contentType = self::contentTypes['v4SubmissionsAssignmentsPut'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\UpdateSubmissionAssignmentsApiResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\UpdateSubmissionAssignmentsApiResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\UpdateSubmissionAssignmentsApiResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\UpdateSubmissionAssignmentsApiResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\UpdateSubmissionAssignmentsApiResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Submittable\Model\RandomSubmissionAssignmentsRequest|null $random_submission_assignments_request random_submission_assignments_request (optional)
     ...
     * Add random assignments to submissions
     *
     * @param  \Submittable\Model\RandomSubmissionAssignmentsRequest|null $random_submission_assignments_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsAssignmentsRandomPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Submittable\Model\BulkImportSubmissionsRequest|null $bulk_import_submissions_request bulk_import_submissions_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\BadRequestResponse|\Submittable\Model\BulkImportSubmissionsResponse
     */
     ...
     * Bulk import submissions
     *
     * @param  \Submittable\Model\BulkImportSubmissionsRequest|null $bulk_import_submissions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsBulkPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\BadRequestResponse|\Submittable\Model\BulkImportSubmissionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsBulkPostWithHttpInfo($bulk_import_submissions_request = null, string $contentType = self::contentTypes['v4SubmissionsBulkPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 201:
                    if ('\Submittable\Model\BulkImportSubmissionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\BulkImportSubmissionsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\BulkImportSubmissionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\BulkImportSubmissionsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\BulkImportSubmissionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Submittable\Model\UpdateSubmissionsIsOpenForEditingRequest|null $update_submissions_is_open_for_editing_request update_submissions_is_open_for_editing_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\SubmissionActionResponse
     */
     ...
     * Close submissions for editing
     *
     * @param  \Submittable\Model\UpdateSubmissionsIsOpenForEditingRequest|null $update_submissions_is_open_for_editing_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsEditingClosePut'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\SubmissionActionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsEditingClosePutWithHttpInfo($update_submissions_is_open_for_editing_request = null, string $contentType = self::contentTypes['v4SubmissionsEditingClosePut'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\SubmissionActionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\SubmissionActionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\SubmissionActionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\SubmissionActionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\SubmissionActionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Submittable\Model\ArchivedStatus|null $archived_status archived_status (optional)
     ...
     * @param  \Submittable\Model\AdditionalFormsStatus[]|null $additional_form_statuses additional_form_statuses (optional)
     * @param  \Submittable\Model\RequestFormsStatus[]|null $request_form_statuses request_form_statuses (optional)
     * @param  \Submittable\Model\ReviewStatus|null $review_status review_status (optional)
     * @param  \Submittable\Model\ReviewStatus|null $reviewer_progress reviewer_progress (optional)
     ...
     * @param  \Submittable\Model\SubmissionSortField|null $sort_by_field sort_by_field (optional)
     * @param  \Submittable\Model\SubmissionSortOrder|null $sort_by_order sort_by_order (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\ContinuationTokenResponseSubmissionListResponse|\Submittable\Model\BadRequestResponse
     */
     ...
     * @param  \Submittable\Model\ArchivedStatus|null $archived_status (optional)
     ...
     * @param  \Submittable\Model\AdditionalFormsStatus[]|null $additional_form_statuses (optional)
     * @param  \Submittable\Model\RequestFormsStatus[]|null $request_form_statuses (optional)
     * @param  \Submittable\Model\ReviewStatus|null $review_status (optional)
     * @param  \Submittable\Model\ReviewStatus|null $reviewer_progress (optional)
     * @param  string[]|null $review_stages_include Include matching ids.  Value is dropped if also included in Exclude. (optional)
     * @param  string[]|null $review_stages_exclude Exclude matching ids (optional)
     * @param  \Submittable\Model\SubmissionSortField|null $sort_by_field (optional)
     * @param  \Submittable\Model\SubmissionSortOrder|null $sort_by_order (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsGet'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\ContinuationTokenResponseSubmissionListResponse|\Submittable\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsGetWithHttpInfo($continuation_token = null, $size = 20, $search = null, $public_organization_ids_include = null, $public_organization_ids_exclude = null, $projects_include = null, $projects_exclude = null, $statuses_include = null, $statuses_exclude = null, $reviewers = null, $archived_status = null, $labels_include_any = null, $labels_include_all = null, $labels_include_unlabeled = null, $labels_exclude_any = null, $labels_exclude_all = null, $labels_exclude_unlabeled = null, $date_from = null, $date_to = null, $additional_form_statuses = null, $request_form_statuses = null, $review_status = null, $reviewer_progress = null, $review_stages_include = null, $review_stages_exclude = null, $sort_by_field = null, $sort_by_order = null, string $contentType = self::contentTypes['v4SubmissionsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\ContinuationTokenResponseSubmissionListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\ContinuationTokenResponseSubmissionListResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\ContinuationTokenResponseSubmissionListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Submittable\Model\ContinuationTokenResponseSubmissionListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\ContinuationTokenResponseSubmissionListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\ContinuationTokenResponseSubmissionHistoryResponse|\Submittable\Model\BadRequestResponse
     */
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\ContinuationTokenResponseSubmissionHistoryResponse|\Submittable\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsHistoryGetWithHttpInfo($submission_id = null, $user_id = null, $history_type_id = null, $bulk_action_task_id = null, $continuation_token = null, $size = 20, string $contentType = self::contentTypes['v4SubmissionsHistoryGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\ContinuationTokenResponseSubmissionHistoryResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\ContinuationTokenResponseSubmissionHistoryResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\ContinuationTokenResponseSubmissionHistoryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Submittable\Model\ContinuationTokenResponseSubmissionHistoryResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\ContinuationTokenResponseSubmissionHistoryResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Submittable\Model\ApplyLabelToSubmissionsRequest|null $apply_label_to_submissions_request apply_label_to_submissions_request (optional)
     ...
     * Add labels to submissions
     *
     * @param  \Submittable\Model\ApplyLabelToSubmissionsRequest|null $apply_label_to_submissions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsLabelsPut'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Submittable\Model\CreateSubmissionMessageBySubmissionIdsRequest|null $create_submission_message_by_submission_ids_request create_submission_message_by_submission_ids_request (optional)
     ...
     * Send submitter a message
     *
     * @param  \Submittable\Model\CreateSubmissionMessageBySubmissionIdsRequest|null $create_submission_message_by_submission_ids_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsMessagePost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * Import a submission
     *
     * @param  \Submittable\Model\V4SubmissionsPostRequest|null $v4_submissions_post_request v4_submissions_post_request (optional)
     ...
     * Import a submission
     *
     * @param  \Submittable\Model\V4SubmissionsPostRequest|null $v4_submissions_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Submittable\Model\UpdateSubmissionPublicOrganizationRequest|null $update_submission_public_organization_request update_submission_public_organization_request (optional)
     ...
     * Update a public organization id associated with a submission
     *
     * @param  \Submittable\Model\UpdateSubmissionPublicOrganizationRequest|null $update_submission_public_organization_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsPublicOrganizationPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Submittable\Model\UpdateSubmissionsReviewStageRequest|null $update_submissions_review_stage_request update_submissions_review_stage_request (optional)
     ...
     * Update review stage on submissions
     *
     * @param  \Submittable\Model\UpdateSubmissionsReviewStageRequest|null $update_submissions_review_stage_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsReviewStagePut'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Submittable\Model\UpdateSubmissionsStatusRequest|null $update_submissions_status_request update_submissions_status_request (optional)
     ...
     * Update status on submissions
     *
     * @param  \Submittable\Model\UpdateSubmissionsStatusRequest|null $update_submissions_status_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsStatusPut'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $submission_id submission_id (required)
     * @param  \Submittable\Model\UpdateSubmissionAssignmentsRequest|null $update_submission_assignments_request update_submission_assignments_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\UpdateSubmissionAssignmentsResponse|\Submittable\Model\BadRequestResponse
     */
     ...
     *
     * @param  string $submission_id (required)
     * @param  \Submittable\Model\UpdateSubmissionAssignmentsRequest|null $update_submission_assignments_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsSubmissionIdAssignmentsPut'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\UpdateSubmissionAssignmentsResponse|\Submittable\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsSubmissionIdAssignmentsPutWithHttpInfo($submission_id, $update_submission_assignments_request = null, string $contentType = self::contentTypes['v4SubmissionsSubmissionIdAssignmentsPut'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\UpdateSubmissionAssignmentsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\UpdateSubmissionAssignmentsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\UpdateSubmissionAssignmentsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Submittable\Model\UpdateSubmissionAssignmentsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\UpdateSubmissionAssignmentsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $submission_id submission_id (required)
     * @param  \Submittable\Model\UploadNoteFileAttachmentRequest|null $upload_note_file_attachment_request upload_note_file_attachment_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\BadRequestResponse|\Submittable\Model\PostFileDataResponse
     */
     ...
     *
     * @param  string $submission_id (required)
     * @param  \Submittable\Model\UploadNoteFileAttachmentRequest|null $upload_note_file_attachment_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsSubmissionIdNotesAttachmentsPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\BadRequestResponse|\Submittable\Model\PostFileDataResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsSubmissionIdNotesAttachmentsPostWithHttpInfo($submission_id, $upload_note_file_attachment_request = null, string $contentType = self::contentTypes['v4SubmissionsSubmissionIdNotesAttachmentsPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Submittable\Model\PostFileDataResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\PostFileDataResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\PostFileDataResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\PostFileDataResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\PostFileDataResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $submission_id submission_id (required)
     * @param  \Submittable\Model\AddNoteToSubmissionRequest|null $add_note_to_submission_request add_note_to_submission_request (optional)
     ...
     *
     * @param  string $submission_id (required)
     * @param  \Submittable\Model\AddNoteToSubmissionRequest|null $add_note_to_submission_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsSubmissionIdNotesPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\UpdateSubmissionReviewStageResponse|\Submittable\Model\BadRequestResponse
     */
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\UpdateSubmissionReviewStageResponse|\Submittable\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsSubmissionIdStageStageIdPutWithHttpInfo($submission_id, $stage_id, string $contentType = self::contentTypes['v4SubmissionsSubmissionIdStageStageIdPut'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\UpdateSubmissionReviewStageResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\UpdateSubmissionReviewStageResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\UpdateSubmissionReviewStageResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Submittable\Model\UpdateSubmissionReviewStageResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\UpdateSubmissionReviewStageResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $submission_id submission_id (required)
     * @param  \Submittable\Model\V4SubmissionsSubmissionIdStatusPutRequest|null $v4_submissions_submission_id_status_put_request v4_submissions_submission_id_status_put_request (optional)
     ...
     *
     * @param  string $submission_id (required)
     * @param  \Submittable\Model\V4SubmissionsSubmissionIdStatusPutRequest|null $v4_submissions_submission_id_status_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsSubmissionIdStatusPut'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $submission_id submission_id (required)
     * @param  \Submittable\Model\CreateTransferRequest|null $create_transfer_request create_transfer_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\BackgroundTaskStatusResponse
     */
     ...
     *
     * @param  string $submission_id (required)
     * @param  \Submittable\Model\CreateTransferRequest|null $create_transfer_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsSubmissionIdTransferPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\BackgroundTaskStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsSubmissionIdTransferPostWithHttpInfo($submission_id, $create_transfer_request = null, string $contentType = self::contentTypes['v4SubmissionsSubmissionIdTransferPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Submittable\Model\BackgroundTaskStatusResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\BackgroundTaskStatusResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\BackgroundTaskStatusResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\BackgroundTaskStatusResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\BackgroundTaskStatusResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\GetAssignmentCountsResponse|\Submittable\Model\BadRequestResponse
     */
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\GetAssignmentCountsResponse|\Submittable\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsTeamAssignmentsGetWithHttpInfo(string $contentType = self::contentTypes['v4SubmissionsTeamAssignmentsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\GetAssignmentCountsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\GetAssignmentCountsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\GetAssignmentCountsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Submittable\Model\GetAssignmentCountsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\GetAssignmentCountsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Submittable\Model\GetPendingTransfersRequest|null $get_pending_transfers_request get_pending_transfers_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\BadRequestResponse|\Submittable\Model\SubmissionPendingTransfersResponse[]
     */
     ...
     * Get pending submission transfer requests
     *
     * @param  \Submittable\Model\GetPendingTransfersRequest|null $get_pending_transfers_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4SubmissionsTransfersPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\BadRequestResponse|\Submittable\Model\SubmissionPendingTransfersResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function v4SubmissionsTransfersPostWithHttpInfo($get_pending_transfers_request = null, string $contentType = self::contentTypes['v4SubmissionsTransfersPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Submittable\Model\SubmissionPendingTransfersResponse[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\SubmissionPendingTransfersResponse[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\SubmissionPendingTransfersResponse[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\SubmissionPendingTransfersResponse[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\SubmissionPendingTransfersResponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
