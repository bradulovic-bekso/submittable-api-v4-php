...
class MessagingApi
{
     ...
     * @return \Submittable\Model\MessageAttachmentResponse
     */
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\MessageAttachmentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4MessagesMessageIdAttachmentsGetWithHttpInfo($message_id, string $contentType = self::contentTypes['v4MessagesMessageIdAttachmentsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\MessageAttachmentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\MessageAttachmentResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\MessageAttachmentResponse', []),
            ...
            $returnType = '\Submittable\Model\MessageAttachmentResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\MessageAttachmentResponse',
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\PlaceholderResponse[]
     */
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\PlaceholderResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function v4MessagesPlaceholdersFormsFormIdGetWithHttpInfo($form_id, string $contentType = self::contentTypes['v4MessagesPlaceholdersFormsFormIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\PlaceholderResponse[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\PlaceholderResponse[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\PlaceholderResponse[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\PlaceholderResponse[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\PlaceholderResponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Submittable\Model\PlaceholderSortField|null $sort_by_field sort_by_field (optional)
     * @param  \Submittable\Model\PlaceholderSortOrder|null $sort_by_order sort_by_order (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\ContinuationTokenResponsePlaceholderResponse
     */
     ...
     * @param  \Submittable\Model\PlaceholderSortField|null $sort_by_field (optional)
     * @param  \Submittable\Model\PlaceholderSortOrder|null $sort_by_order (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4MessagesPlaceholdersGet'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\ContinuationTokenResponsePlaceholderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4MessagesPlaceholdersGetWithHttpInfo($continuation_token = null, $size = 20, $search = null, $include_disabled = null, $include_standard = null, $sort_by_field = null, $sort_by_order = null, string $contentType = self::contentTypes['v4MessagesPlaceholdersGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Submittable\Model\ContinuationTokenResponsePlaceholderResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\ContinuationTokenResponsePlaceholderResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\ContinuationTokenResponsePlaceholderResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\ContinuationTokenResponsePlaceholderResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\ContinuationTokenResponsePlaceholderResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $placeholder_id placeholder_id (required)
     * @param  \Submittable\Model\UpdateCustomPlaceholderRequest|null $update_custom_placeholder_request update_custom_placeholder_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\PlaceholderResponse|\Submittable\Model\BadRequestResponse
     */
     ...
     *
     * @param  string $placeholder_id (required)
     * @param  \Submittable\Model\UpdateCustomPlaceholderRequest|null $update_custom_placeholder_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4MessagesPlaceholdersPlaceholderIdPut'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\PlaceholderResponse|\Submittable\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  \Submittable\Model\CreateCustomPlaceholderRequest|null $create_custom_placeholder_request create_custom_placeholder_request (optional)
     ...
     * Create a new Custom Placeholder
     *
     * @param  \Submittable\Model\CreateCustomPlaceholderRequest|null $create_custom_placeholder_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4MessagesPlaceholdersPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Submittable\Model\CreateResponseTemplateRequest|null $create_response_template_request create_response_template_request (optional)
     ...
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Submittable\Model\CreateResponseTemplateResponse
     */
     ...
     * Create or update a response template
     *
     * @param  \Submittable\Model\CreateResponseTemplateRequest|null $create_response_template_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4MessagesResponsesTemplatesPost'] to see the possible values for this operation
     *
     * @throws \Submittable\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Submittable\Model\CreateResponseTemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4MessagesResponsesTemplatesPostWithHttpInfo($create_response_template_request = null, string $contentType = self::contentTypes['v4MessagesResponsesTemplatesPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Submittable\Model\CreateResponseTemplateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Submittable\Model\CreateResponseTemplateResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Submittable\Model\CreateResponseTemplateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Submittable\Model\CreateResponseTemplateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Submittable\Model\CreateResponseTemplateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
