...
class FundsApi
{
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\FundResponse|\OpenAPI\Client\Model\BadRequestResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\FundResponse|\OpenAPI\Client\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4FundsFundIdGetWithHttpInfo($fund_id, string $contentType = self::contentTypes['v4FundsFundIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\FundResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\FundResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\FundResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\FundResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\FundResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $fund_id fund_id (required)
     * @param  \OpenAPI\Client\Model\UpdateFundRequest|null $update_fund_request update_fund_request (optional)
     ...
     *
     * @param  string $fund_id (required)
     * @param  \OpenAPI\Client\Model\UpdateFundRequest|null $update_fund_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4FundsFundIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ContinuationTokenResponseFundResponse|\OpenAPI\Client\Model\BadRequestResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ContinuationTokenResponseFundResponse|\OpenAPI\Client\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4FundsGetWithHttpInfo($continuation_token = null, $size = 20, string $contentType = self::contentTypes['v4FundsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ContinuationTokenResponseFundResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ContinuationTokenResponseFundResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ContinuationTokenResponseFundResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\ContinuationTokenResponseFundResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ContinuationTokenResponseFundResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Create a fund
     *
     * @param  \OpenAPI\Client\Model\CreateFundRequest|null $create_fund_request create_fund_request (optional)
     ...
     * Create a fund
     *
     * @param  \OpenAPI\Client\Model\CreateFundRequest|null $create_fund_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4FundsPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse|\OpenAPI\Client\Model\BadRequestResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse|\OpenAPI\Client\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4TransactionsGetWithHttpInfo($continuation_token = null, $size = 20, $fund_id = null, $status = null, $start_date = null, $end_date = null, $submitter_id = null, $submission_id = null, $public_organization_id = null, string $contentType = self::contentTypes['v4TransactionsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Model\V4TransactionsPostRequest|null $v4_transactions_post_request v4_transactions_post_request (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TransactionResponse|\OpenAPI\Client\Model\BadRequestResponse
     */
     ...
     * Create a transaction
     *
     * @param  \OpenAPI\Client\Model\V4TransactionsPostRequest|null $v4_transactions_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4TransactionsPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TransactionResponse|\OpenAPI\Client\Model\BadRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \OpenAPI\Client\Model\DeleteTransactionRequest|null $delete_transaction_request delete_transaction_request (optional)
     ...
     * @param  \OpenAPI\Client\Model\DeleteTransactionRequest|null $delete_transaction_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4TransactionsTransactionIdDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\BadRequestResponse|\OpenAPI\Client\Model\TransactionResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\BadRequestResponse|\OpenAPI\Client\Model\TransactionResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $transaction_id transaction_id (required)
     * @param  \OpenAPI\Client\Model\UpdateTransactionRequest|null $update_transaction_request update_transaction_request (optional)
     ...
     *
     * @param  string $transaction_id (required)
     * @param  \OpenAPI\Client\Model\UpdateTransactionRequest|null $update_transaction_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4TransactionsTransactionIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $transaction_id transaction_id (required)
     * @param  \OpenAPI\Client\Model\SendFundsRequest|null $send_funds_request send_funds_request (optional)
     ...
     *
     * @param  string $transaction_id (required)
     * @param  \OpenAPI\Client\Model\SendFundsRequest|null $send_funds_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v4TransactionsTransactionIdSendPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
