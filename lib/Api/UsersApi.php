...
class UsersApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\GetSubmissionsSubmittersRequest|null $get_submissions_submitters_request get_submissions_submitters_request (optional)
     ...
     * @return \OpenAPI\Client\Model\BadRequestResponse|\OpenAPI\Client\Model\SubmittersResponse[]
     */
     ...
     * Get submitters for list of submission ids
     *
     * @param  \OpenAPI\Client\Model\GetSubmissionsSubmittersRequest|null $get_submissions_submitters_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSubmitters'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\BadRequestResponse|\OpenAPI\Client\Model\SubmittersResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubmittersWithHttpInfo($get_submissions_submitters_request = null, string $contentType = self::contentTypes['getSubmitters'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\SubmittersResponse[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\SubmittersResponse[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SubmittersResponse[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\SubmittersResponse[]';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SubmittersResponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\BadRequestResponse|\OpenAPI\Client\Model\SubmitterResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\BadRequestResponse|\OpenAPI\Client\Model\SubmitterResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4UsersSubmissionsSubmissionIdSubmitterGetWithHttpInfo($submission_id, string $contentType = self::contentTypes['v4UsersSubmissionsSubmissionIdSubmitterGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\SubmitterResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\SubmitterResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SubmitterResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\SubmitterResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SubmitterResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
