...
```php
v4EntriesAdditionalPost($create_additional_form_entry_request): \Submittable\Model\AdditionalFormEntryResponse
```
...
| ------------- | ------------- | ------------- | ------------- |
| **create_additional_form_entry_request** | [**\Submittable\Model\CreateAdditionalFormEntryRequest**](../Model/CreateAdditionalFormEntryRequest.md)|  | [optional] |

### Return type

[**\Submittable\Model\AdditionalFormEntryResponse**](../Model/AdditionalFormEntryResponse.md)
...
$rescind_additional_forms_request = new \Submittable\Model\RescindAdditionalFormsRequest(); // \Submittable\Model\RescindAdditionalFormsRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **rescind_additional_forms_request** | [**\Submittable\Model\RescindAdditionalFormsRequest**](../Model/RescindAdditionalFormsRequest.md)|  | [optional] |
...
$update_entries_is_open_for_editing_request = new \Submittable\Model\UpdateEntriesIsOpenForEditingRequest(); // \Submittable\Model\UpdateEntriesIsOpenForEditingRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_entries_is_open_for_editing_request** | [**\Submittable\Model\UpdateEntriesIsOpenForEditingRequest**](../Model/UpdateEntriesIsOpenForEditingRequest.md)|  | [optional] |
...
$update_is_open_for_editing_request = new \Submittable\Model\UpdateIsOpenForEditingRequest(); // \Submittable\Model\UpdateIsOpenForEditingRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **entry_id** | **string**|  | |
| **update_is_open_for_editing_request** | [**\Submittable\Model\UpdateIsOpenForEditingRequest**](../Model/UpdateIsOpenForEditingRequest.md)|  | [optional] |
...
```php
v4EntriesEntryIdFieldsFieldIdPost($entry_id, $field_id, $create_response_file_request): \Submittable\Model\CreateFileResult
```
...
$create_response_file_request = new \Submittable\Model\CreateResponseFileRequest(); // \Submittable\Model\CreateResponseFileRequest
...
| **entry_id** | **string**|  | |
| **field_id** | **string**|  | |
| **create_response_file_request** | [**\Submittable\Model\CreateResponseFileRequest**](../Model/CreateResponseFileRequest.md)|  | [optional] |

### Return type

[**\Submittable\Model\CreateFileResult**](../Model/CreateFileResult.md)
...
```php
v4EntriesEntryIdFilesFileIdGet($entry_id, $file_id): \Submittable\Model\GetUrlResponse
```
...
[**\Submittable\Model\GetUrlResponse**](../Model/GetUrlResponse.md)
...
```php
v4EntriesEntryIdGet($entry_id, $prefer_original_version, $include_drafts): \Submittable\Model\V4EntriesEntryIdGet200Response
```
...
[**\Submittable\Model\V4EntriesEntryIdGet200Response**](../Model/V4EntriesEntryIdGet200Response.md)
...
$entry_id = 'entry_id_example'; // string
$v4_entries_entry_id_patch_request = new \Submittable\Model\V4EntriesEntryIdPatchRequest(); // \Submittable\Model\V4EntriesEntryIdPatchRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **entry_id** | **string**|  | |
| **v4_entries_entry_id_patch_request** | [**\Submittable\Model\V4EntriesEntryIdPatchRequest**](../Model/V4EntriesEntryIdPatchRequest.md)|  | [optional] |
...
```php
v4EntriesEntryIdPut($entry_id, $v4_entries_entry_id_put_request): \Submittable\Model\V4EntriesEntryIdGet200Response
```
...
$entry_id = 'entry_id_example'; // string
$v4_entries_entry_id_put_request = new \Submittable\Model\V4EntriesEntryIdPutRequest(); // \Submittable\Model\V4EntriesEntryIdPutRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **entry_id** | **string**|  | |
| **v4_entries_entry_id_put_request** | [**\Submittable\Model\V4EntriesEntryIdPutRequest**](../Model/V4EntriesEntryIdPutRequest.md)|  | [optional] |
...
```php
v4EntriesEntryIdTablesTableIdGet($entry_id, $table_id): \Submittable\Model\GetUrlResponse
```
...
```php
v4EntriesFormsFormIdGet($form_id, $continuation_token, $size): \Submittable\Model\ContinuationTokenResponseAnyFormTypeEntryResponse
```
...
[**\Submittable\Model\ContinuationTokenResponseAnyFormTypeEntryResponse**](../Model/ContinuationTokenResponseAnyFormTypeEntryResponse.md)
...
```php
v4EntriesInternalPost($create_internal_form_entry_request): \Submittable\Model\InternalFormEntryResponse
```
...
$create_internal_form_entry_request = new \Submittable\Model\CreateInternalFormEntryRequest(); // \Submittable\Model\CreateInternalFormEntryRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_internal_form_entry_request** | [**\Submittable\Model\CreateInternalFormEntryRequest**](../Model/CreateInternalFormEntryRequest.md)|  | [optional] |

### Return type

[**\Submittable\Model\InternalFormEntryResponse**](../Model/InternalFormEntryResponse.md)
...
$send_message_to_entries_request = new \Submittable\Model\SendMessageToEntriesRequest(); // \Submittable\Model\SendMessageToEntriesRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **send_message_to_entries_request** | [**\Submittable\Model\SendMessageToEntriesRequest**](../Model/SendMessageToEntriesRequest.md)|  | [optional] |
...
$sort_by_sort = new \Submittable\Model\\Submittable\Model\FormEntrySortField(); // \Submittable\Model\FormEntrySortField | 'dateSent', 'status' and 'deadline' only for Additional form entries. 'dateSubmitted' and 'requestFormEntryStatus' only for Request form entries
$sort_by_direction = new \Submittable\Model\\Submittable\Model\FormEntrySortOrder(); // \Submittable\Model\FormEntrySortOrder
...
| **sort_by_sort** | [**\Submittable\Model\FormEntrySortField**](../Model/.md)| &#39;dateSent&#39;, &#39;status&#39; and &#39;deadline&#39; only for Additional form entries. &#39;dateSubmitted&#39; and &#39;requestFormEntryStatus&#39; only for Request form entries | [optional] |
| **sort_by_direction** | [**\Submittable\Model\FormEntrySortOrder**](../Model/.md)|  | [optional] |
...
[**\Submittable\Model\ContinuationTokenResponseAnyFormTypeEntryMetadataResponse**](../Model/ContinuationTokenResponseAnyFormTypeEntryMetadataResponse.md)
...
$update_request_form_is_open_for_editing_by_filter_request = new \Submittable\Model\UpdateRequestFormIsOpenForEditingByFilterRequest(); // \Submittable\Model\UpdateRequestFormIsOpenForEditingByFilterRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_request_form_is_open_for_editing_by_filter_request** | [**\Submittable\Model\UpdateRequestFormIsOpenForEditingByFilterRequest**](../Model/UpdateRequestFormIsOpenForEditingByFilterRequest.md)|  | [optional] |
...
$update_request_form_entry_status_request = new \Submittable\Model\UpdateRequestFormEntryStatusRequest(); // \Submittable\Model\UpdateRequestFormEntryStatusRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_request_form_entry_status_request** | [**\Submittable\Model\UpdateRequestFormEntryStatusRequest**](../Model/UpdateRequestFormEntryStatusRequest.md)|  | [optional] |
...
```php
v4EntriesReviewsScorePut($update_review_score_request): \Submittable\Model\ReviewFormEntryResponse
```
...
$update_review_score_request = new \Submittable\Model\UpdateReviewScoreRequest(); // \Submittable\Model\UpdateReviewScoreRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_review_score_request** | [**\Submittable\Model\UpdateReviewScoreRequest**](../Model/UpdateReviewScoreRequest.md)|  | [optional] |

### Return type

[**\Submittable\Model\ReviewFormEntryResponse**](../Model/ReviewFormEntryResponse.md)
...
```php
v4EntriesSubmissionsSubmissionIdGet($submission_id): \Submittable\Model\FormEntriesForSubmissionResponse
```
...
[**\Submittable\Model\FormEntriesForSubmissionResponse**](../Model/FormEntriesForSubmissionResponse.md)
...
```php
v4EntriesSubmissionsSubmissionIdReviewsGet($submission_id, $review_stage_id): \Submittable\Model\ReviewFormEntryResponse[]
```
...
```php
v4FormsFormIdGet($form_id): \Submittable\Model\V4FormsPost201Response
```
...
[**\Submittable\Model\V4FormsPost201Response**](../Model/V4FormsPost201Response.md)
...
```php
v4FormsFormIdPut($form_id, $v4_forms_post_request): \Submittable\Model\V4FormsPost201Response
```
...
$form_id = 'form_id_example'; // string
$v4_forms_post_request = new \Submittable\Model\V4FormsPostRequest(); // \Submittable\Model\V4FormsPostRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **form_id** | **string**|  | |
| **v4_forms_post_request** | [**\Submittable\Model\V4FormsPostRequest**](../Model/V4FormsPostRequest.md)|  | [optional] |
...
```php
v4FormsGet($continuation_token, $size, $type, $project_id): \Submittable\Model\ContinuationTokenResponseFormResponseV4
```
...
[**\Submittable\Model\ContinuationTokenResponseFormResponseV4**](../Model/ContinuationTokenResponseFormResponseV4.md)
...
```php
v4FormsMetadataGet($continuation_token, $size, $type, $project_id): \Submittable\Model\ContinuationTokenResponseFormMetadataResponse
```
...
[**\Submittable\Model\ContinuationTokenResponseFormMetadataResponse**](../Model/ContinuationTokenResponseFormMetadataResponse.md)
...
```php
v4FormsPost($v4_forms_post_request): \Submittable\Model\V4FormsPost201Response
```
...
```php
v4FormsSubmissionIdScheduledGet($submission_id): \Submittable\Model\ScheduledAdditionalFormsBySubmissionIdResponse
```
...
[**\Submittable\Model\ScheduledAdditionalFormsBySubmissionIdResponse**](../Model/ScheduledAdditionalFormsBySubmissionIdResponse.md)
...
```php
v4FormsTemplatesPaymentGet(): \Submittable\Model\FormTemplateResponse
```
...
[**\Submittable\Model\FormTemplateResponse**](../Model/FormTemplateResponse.md)
