...
```php
v4FundsFundIdGet($fund_id): \OpenAPI\Client\Model\FundResponse
```
...
[**\OpenAPI\Client\Model\FundResponse**](../Model/FundResponse.md)
...
```php
v4FundsFundIdPut($fund_id, $update_fund_request): \OpenAPI\Client\Model\FundResponse
```
...
$fund_id = 'fund_id_example'; // string
$update_fund_request = new \OpenAPI\Client\Model\UpdateFundRequest(); // \OpenAPI\Client\Model\UpdateFundRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **fund_id** | **string**|  | |
| **update_fund_request** | [**\OpenAPI\Client\Model\UpdateFundRequest**](../Model/UpdateFundRequest.md)|  | [optional] |
...
```php
v4FundsGet($continuation_token, $size): \OpenAPI\Client\Model\ContinuationTokenResponseFundResponse
```
...
[**\OpenAPI\Client\Model\ContinuationTokenResponseFundResponse**](../Model/ContinuationTokenResponseFundResponse.md)
...
```php
v4FundsPost($create_fund_request): \OpenAPI\Client\Model\FundResponse
```
...
$create_fund_request = new \OpenAPI\Client\Model\CreateFundRequest(); // \OpenAPI\Client\Model\CreateFundRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_fund_request** | [**\OpenAPI\Client\Model\CreateFundRequest**](../Model/CreateFundRequest.md)|  | [optional] |
...
```php
v4TransactionsGet($continuation_token, $size, $fund_id, $status, $start_date, $end_date, $submitter_id, $submission_id, $public_organization_id): \OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse
```
...
[**\OpenAPI\Client\Model\ContinuationTokenResponseTransactionResponse**](../Model/ContinuationTokenResponseTransactionResponse.md)
...
```php
v4TransactionsPost($v4_transactions_post_request): \OpenAPI\Client\Model\TransactionResponse
```
...
$v4_transactions_post_request = new \OpenAPI\Client\Model\V4TransactionsPostRequest(); // \OpenAPI\Client\Model\V4TransactionsPostRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **v4_transactions_post_request** | [**\OpenAPI\Client\Model\V4TransactionsPostRequest**](../Model/V4TransactionsPostRequest.md)|  | [optional] |
...
| **delete_transaction_request** | [**\OpenAPI\Client\Model\DeleteTransactionRequest**](../Model/DeleteTransactionRequest.md)|  | [optional] |
...
```php
v4TransactionsTransactionIdGet($transaction_id): \OpenAPI\Client\Model\TransactionResponse
```
...
```php
v4TransactionsTransactionIdPut($transaction_id, $update_transaction_request): \OpenAPI\Client\Model\TransactionResponse
```
...
$transaction_id = 'transaction_id_example'; // string
$update_transaction_request = new \OpenAPI\Client\Model\UpdateTransactionRequest(); // \OpenAPI\Client\Model\UpdateTransactionRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **transaction_id** | **string**|  | |
| **update_transaction_request** | [**\OpenAPI\Client\Model\UpdateTransactionRequest**](../Model/UpdateTransactionRequest.md)|  | [optional] |
...
```php
v4TransactionsTransactionIdSendPost($transaction_id, $send_funds_request): \OpenAPI\Client\Model\TransactionResponse
```
...
$transaction_id = 'transaction_id_example'; // string
$send_funds_request = new \OpenAPI\Client\Model\SendFundsRequest(); // \OpenAPI\Client\Model\SendFundsRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **transaction_id** | **string**|  | |
| **send_funds_request** | [**\OpenAPI\Client\Model\SendFundsRequest**](../Model/SendFundsRequest.md)|  | [optional] |
